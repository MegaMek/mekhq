...
public class CampaignTest {
    ...
    public void testGetTechs() {
        ...
        Mockito.when(testCampaign.getTechs(Mockito.anyBoolean(), Mockito.any(UUID.class))).thenCallRealMethod();
        ...
        expected.add(mockTechActive);
        expected.add(mockTechNoTime);
        Assert.assertEquals(expected, testCampaign.getTechs(false, testId));
    }
