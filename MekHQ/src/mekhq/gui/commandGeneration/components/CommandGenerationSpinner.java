 ...
 */
public class CommandGenerationSpinner extends JSpinner {
     ...
     */
    public CommandGenerationSpinner(String name, int defaultValue, int minimum, int maximum, int stepSize) {
     ...
     */
    public CommandGenerationSpinner(String name, double defaultValue, double minimum, double maximum,
          double stepSize) {
        this(name, (Number) defaultValue, minimum, maximum, stepSize);
    }

    private CommandGenerationSpinner(String name, Number defaultValue, Number minimum, Number maximum,
          Number stepSize) {
