...
public class PersonnelTableModel extends DataTableModel {
    ...
    private transient PersonnelMarket personnelMarket;
    private boolean loadAssignmentFromMarket;
    private boolean groupByUnit;

    private transient final MekHqColors colors = new MekHqColors();

    public static final int COL_RANK            = 0;
    public static final int COL_PRE_NOMINAL     = 1;
    public static final int COL_GIVEN_NAME      = 2;
    public static final int COL_SURNAME         = 3;
    public static final int COL_BLOODNAME       = 4;
    public static final int COL_POST_NOMINAL    = 5;
    ...
    public static final int N_COL               = 45;
    ...
    public String getColumnName(int column) {
        switch(column) {
            ...
            case COL_PRE_NOMINAL:
                return resources.getString("col_pre_nominal.text");
            case COL_GIVEN_NAME:
                return resources.getString("col_given_name.text");
            case COL_SURNAME:
                return resources.getString("col_surname.text");
            case COL_POST_NOMINAL:
                return resources.getString("col_post_nominal.text");
            case COL_CALL:
    ...
    public Object getValueAt(int row, int col) {
        ...
        switch (col) {
            ...
            case COL_PRE_NOMINAL:
                toReturn = p.getPreNominal();
                return !StringUtil.isNullOrEmpty(toReturn) ? toReturn : "";
            case COL_GIVEN_NAME:
