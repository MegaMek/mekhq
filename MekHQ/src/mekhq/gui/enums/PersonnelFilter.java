...
public enum PersonnelFilter {
    ...
    COMBAT_TECHNICIANS("PersonnelFilter.COMBAT_TECHNICIANS.text",
          ...
          false,
          true),
    COMMS_OPERATORS("PersonnelFilter.COMMS_OPERATORS.text",
          "PersonnelFilter.COMMS_OPERATORS.toolTipText",
          false,
          true),
    ...
    public boolean getFilteredInformation(final Person person, LocalDate currentDate) {
        ...
        return switch (this) {
            ...
            case COMMS_OPERATORS -> active && (MekHQ.getMHQOptions().getPersonnelFilterOnPrimaryRole() ?
