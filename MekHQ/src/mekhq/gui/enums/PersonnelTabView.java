...
public enum PersonnelTabView {
    ...
    EQUIPMENT_KITS("PersonnelTabView.EQUIPMENT_KITS.text", "PersonnelTabView.EQUIPMENT_KITS.toolTipText",
          Set.of(RANK, FIRST_NAME, LAST_NAME, PERSONNEL_ROLE, UNIT_ASSIGNMENT, ARMOR_KIT, EQUIPMENT)),
