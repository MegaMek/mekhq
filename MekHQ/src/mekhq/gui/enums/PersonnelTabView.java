...
public enum PersonnelTabView {
    ...
    HEALTHCARE("PersonnelTabView.HEALTHCARE.text", "PersonnelTabView.HEALTHCARE.toolTipText",
          Set.of(RANK, FIRST_NAME, LAST_NAME, PERSONNEL_ROLE, AGE, INJURIES, TOUGHNESS, BODY, COVER_MEDICAL_EXPENSES,
                DUE_DATE),
    ...
    SERVICE_RECORD("PersonnelTabView.SERVICE_RECORD.text", "PersonnelTabView.SERVICE_RECORD.toolTipText",
          Set.of(RANK, FIRST_NAME, LAST_NAME, PERSONNEL_ROLE, COMMAND_STATUS, FOUNDER, RECRUITMENT_DATE,
                RETIREMENT_DATE, LAST_RANK_CHANGE_DATE, SALARY),
    ...
    BIOGRAPHICAL("PersonnelTabView.BIOGRAPHICAL.text", "PersonnelTabView.BIOGRAPHICAL.toolTipText",
          Set.of(RANK, FIRST_NAME, LAST_NAME, PERSONNEL_ROLE, AGE, DEATH_DATE, PERSONNEL_STATUS, HIGHEST_EDUCATION,
                ORIGIN_FACTION, ORIGIN_PLANET),
    ...
    FLAGS_A("PersonnelTabView.FLAGS_A.text", "PersonnelTabView.FLAGS_A.toolTipText",
          Set.of(RANK, FIRST_NAME, LAST_NAME, SALVAGE_SUPERVISOR, QUICK_TRAIN_IGNORE, NEVER_ASSIGN_AUTO_MAINTENANCE,
                BLOCK_MATERNITY_LEAVE, CLAN_PERSONNEL, UNDER_PROTECTION, IMMORTAL)),
    OTHER("PersonnelTabView.OTHER.text", "PersonnelTabView.OTHER.toolTipText",
          Set.of(RANK, FIRST_NAME, LAST_NAME, FATIGUE, SPA_COUNT, IMPLANT_COUNT, MODIFICATION_COUNT, LOYALTY),
