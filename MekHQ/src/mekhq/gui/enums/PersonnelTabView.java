...
public enum PersonnelTabView {
    ...
    SERVICE_RECORD("PersonnelTabView.SERVICE_RECORD.text", "PersonnelTabView.SERVICE_RECORD.toolTipText",
          Set.of(RANK, FIRST_NAME, LAST_NAME, PERSONNEL_ROLE, COMMAND_STATUS, FOUNDER, RECRUITMENT_DATE,
                RETIREMENT_DATE, LAST_RANK_CHANGE_DATE, SALARY, KILLS),
    ...
    FLAGS("PersonnelTabView.FLAGS.text", "PersonnelTabView.FLAGS.toolTipText",
          Set.of(RANK, FIRST_NAME, LAST_NAME, QUICK_TRAIN_IGNORE, BLOCK_MATERNITY_LEAVE, CLAN_PERSONNEL,
                UNDER_PROTECTION, IMMORTAL)),
