...
public class PrisonerEventDialog extends ImmersiveDialogCore {
     ...
     * @param speaker  The character delivering the message in the dialog, or {@code null} if no speaker is defined.
    ...
    public PrisonerEventDialog(Campaign campaign, @Nullable Person speaker, PrisonerEvent event) {
        super(campaign,
              speaker,
              null,
              createInCharacterMessage(campaign, event),
              createButtons(event),
     ...
     * indicate the choice and accompanied by a tooltip for additional context. The available options and their
     * corresponding labels and tooltips are retrieved based on the specific event type.</p>
     *
     ...
     * player using their in-game title or designation. The content is tailored to the specific type of prisoner event
     * that has occurred.</p>
     *
