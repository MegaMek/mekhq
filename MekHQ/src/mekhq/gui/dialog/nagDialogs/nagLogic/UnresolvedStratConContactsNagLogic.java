...
public class UnresolvedStratConContactsNagLogic {
     ...
     * to see if it contains any unresolved contacts. If the report is not empty, it indicates that
     * there are unresolved StratCon scenarios, and the method returns {@code true}. Otherwise, it returns {@code false}.</p>
     *
     ...
     * scenarios on their StratCon tracks. A scenario is considered unresolved if both of the following conditions are true:</p>
     * <ul>
     ...
     * @param today The current campaign date used to filter scenarios by deployment date.
     *
     * @return A formatted HTML string summarizing all unresolved scenarios, with critical scenarios (e.g., Turning Points) marked.
     */
