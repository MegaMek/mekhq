    ...
    private void initComponents() {
        ...
        for (Contract contract : contractMarket.getContracts()) {
            ...
            if (contract instanceof AtBContract atbContract) {
                ...
                atbContract.setSharesPercent(campaign.getCampaignOptions().get(CampaignOption.USE_SHARE_SYSTEM) ?
        ...
        btnGenerate.addActionListener(evt -> {
            ...
            contract.setSharesPercent(campaign.getCampaignOptions().get(CampaignOption.USE_SHARE_SYSTEM) ?
                                            (Integer) spnSharePct.getValue() :
                                            0);
            contract.setStartDate(null);
            contract.setPaidMRBCFee(payMRBC);
