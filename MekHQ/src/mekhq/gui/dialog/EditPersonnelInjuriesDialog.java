...
public class EditPersonnelInjuriesDialog extends JDialog {
    ...
    public class InjuryTableModel extends AbstractTableModel {
        ...
        public static final int COL_DAYS	=	0;
        public static final int COL_LOCATION =	1;
        public static final int COL_TYPE	=	2;
        public static final int COL_FLUFF	=	3;
        public static final int COL_HITS	=	4;
        public static final int COL_PERMANENT =	5;
        public static final int COL_WORKEDON =	6;
        public static final int COL_EXTENDED =	7;
