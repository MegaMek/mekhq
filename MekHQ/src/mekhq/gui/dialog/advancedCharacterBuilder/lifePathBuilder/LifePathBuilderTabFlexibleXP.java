...
public class LifePathBuilderTabFlexibleXP {
    ...
    public LifePathBuilderTabFlexibleXP(LifePathBuilderDialog parent, EnhancedTabbedPane tabMain) {
        this.parent = parent;
    ...
    private void addFlexibleXPTab(EnhancedTabbedPane tabbedPane, @Nullable LifePathTabStorage storage) {
        ...
        LifePathTabStorage initialStorage = getFlexibleXPTabStorage(
              attributes,
              traits,
              skills,
              abilities);
    ...
    private void standardizedActions(int index, Map<SkillAttribute, Integer> attributes,
        ...
        LifePathTabStorage storage = getFlexibleXPTabStorage(
              attributes,
              traits,
              skills,
              abilities);
    ...
    private static LifePathTabStorage getFlexibleXPTabStorage(Map<SkillAttribute, Integer> attributes,
          Map<LifePathEntryDataTraitLookup, Integer> traits, Map<SkillType, Integer> skills,
