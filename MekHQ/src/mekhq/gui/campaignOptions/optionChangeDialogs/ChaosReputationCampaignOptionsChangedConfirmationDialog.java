...
/**
 * One-time confirmation dialog shown when the Chaos Campaign reputation system is first enabled for an existing
 * campaign. It introduces the system and offers to retroactively initialize the force's (and its personnel's)
 * reputation from past contracts. Accepting is a permanent change.
 */
public class ChaosReputationCampaignOptionsChangedConfirmationDialog extends JDialog {
    private static final String RESOURCE_BUNDLE =
          "mekhq.resources.ChaosReputationCampaignOptionsChangedConfirmationDialog";
    ...
    public ChaosReputationCampaignOptionsChangedConfirmationDialog(Campaign campaign) {
    ...
    private JPanel populateCenterPanel() {
        ...
        String description = getFormattedTextAt(RESOURCE_BUNDLE,
              "ChaosReputationCampaignOptionsChangedConfirmationDialog.description",
    ...
    private JPanel createButtonPanel() {
        ...
        RoundedJButton btnCancel = new RoundedJButton(getTextAt(RESOURCE_BUNDLE,
              "ChaosReputationCampaignOptionsChangedConfirmationDialog.cancel"));
        btnCancel.addActionListener(evt -> dispose());

        RoundedJButton btnConfirm = new RoundedJButton(getTextAt(RESOURCE_BUNDLE,
              "ChaosReputationCampaignOptionsChangedConfirmationDialog.confirm"));
        btnConfirm.addActionListener(evt -> {
            int reputation = ChaosReputation.applyRetroactiveContractReputation(campaign);
            campaign.addReport(DailyReportType.GENERAL, getFormattedTextAt(RESOURCE_BUNDLE,
                  "ChaosReputationCampaignOptionsChangedConfirmationDialog.report",
                  reputation));
            dispose();
        });
