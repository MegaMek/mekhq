...
/**
 * Confirmation dialog shown when the "require MekWarrior kit to deploy" option is newly enabled, offering to equip
 * every player MekWarrior with a MekWarrior kit so the force is not immediately grounded. The Clan kit is issued to a
 * Clan force, otherwise the Basic kit.
 */
public class MekWarriorKitCampaignOptionsChangedConfirmationDialog extends JDialog {
    private static final String RESOURCE_BUNDLE =
          "mekhq.resources.MekWarriorKitCampaignOptionsChangedConfirmationDialog";
    ...
    public MekWarriorKitCampaignOptionsChangedConfirmationDialog(Campaign campaign) {
    ...
    private JPanel populateCenterPanel() {
        ...
        String description = getFormattedTextAt(RESOURCE_BUNDLE,
              "MekWarriorKitCampaignOptionsChangedConfirmationDialog.description",
    ...
    private JPanel createButtonPanel() {
        ...
        RoundedJButton btnCancel = new RoundedJButton(getTextAt(RESOURCE_BUNDLE,
              "MekWarriorKitCampaignOptionsChangedConfirmationDialog.cancel"));
        btnCancel.addActionListener(evt -> dispose());

        RoundedJButton btnConfirm = new RoundedJButton(getTextAt(RESOURCE_BUNDLE,
              "MekWarriorKitCampaignOptionsChangedConfirmationDialog.confirm"));
        btnConfirm.addActionListener(evt -> {
            equipMekWarriors(campaign);
            dispose();
        });
     ...
     *
     * @param campaign the campaign whose MekWarriors are equipped
     */
    public static void equipMekWarriors(Campaign campaign) {
        String kit = campaign.getPlayerForce().isClanForce()
                           ? ArmorKitCatalog.KIT_MEKWARRIOR_CLAN
                           : ArmorKitCatalog.KIT_MEKWARRIOR_BASIC;
        ArmorKitIssuer.equipAllMekWarriorsWithKit(campaign, kit);
    }
}
