...
import static mekhq.campaign.universe.companyGeneration.SupportTOEFormationTypes.COMMISSARY_FORMATION;
...
public class FatigueTrackingCampaignOptionsChangedConfirmationDialog extends JDialog {
    ...
    public static void processFreeUnit(Campaign campaign, Faction faction, boolean isAutomaticallyAssignRanks) {
        ...
        if (!units.isEmpty()) {
            AddSupportUnitsToTOE.addSupportUnitsToTOE(campaign, units, COMMISSARY_FORMATION);
        }
    }
}
