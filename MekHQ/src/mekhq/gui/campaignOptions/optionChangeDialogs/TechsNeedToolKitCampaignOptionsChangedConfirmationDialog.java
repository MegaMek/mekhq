...
/**
 * Confirmation dialog shown when the "Techs Need a Tool Kit" option is newly enabled, offering to issue a Basic Toolkit
 * to every technician who carries none, so the workforce is not immediately unable to make repairs.
 */
public class TechsNeedToolKitCampaignOptionsChangedConfirmationDialog extends JDialog {
    private static final String RESOURCE_BUNDLE =
          "mekhq.resources.TechsNeedToolKitCampaignOptionsChangedConfirmationDialog";
    ...
    public TechsNeedToolKitCampaignOptionsChangedConfirmationDialog(Campaign campaign) {
    ...
    private JPanel populateCenterPanel() {
        ...
        String description = getFormattedTextAt(RESOURCE_BUNDLE,
              "TechsNeedToolKitCampaignOptionsChangedConfirmationDialog.description",
    ...
    private JPanel createButtonPanel() {
        ...
        RoundedJButton btnCancel = new RoundedJButton(getTextAt(RESOURCE_BUNDLE,
              "TechsNeedToolKitCampaignOptionsChangedConfirmationDialog.cancel"));
        btnCancel.addActionListener(evt -> dispose());

        RoundedJButton btnConfirm = new RoundedJButton(getTextAt(RESOURCE_BUNDLE,
              "TechsNeedToolKitCampaignOptionsChangedConfirmationDialog.confirm"));
