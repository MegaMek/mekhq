...
/**
 * Confirmation dialog shown when the granular specialist tech skills are newly enabled in a campaign that previously
 * used only the global tech skills (that is, the "use global tech skills only" option has just been switched off).
 * Offers to give every existing technician the supplemental specialist skills their profession expects, since those
 * skills were not handed out while the option was on.
 */
public class SpecialistTechSkillsCampaignOptionsChangedConfirmationDialog extends JDialog {
    private static final String RESOURCE_BUNDLE =
          "mekhq.resources.SpecialistTechSkillsCampaignOptionsChangedConfirmationDialog";
    ...
    public SpecialistTechSkillsCampaignOptionsChangedConfirmationDialog(Campaign campaign) {
    ...
    private JPanel populateCenterPanel() {
        ...
        String description = getFormattedTextAt(RESOURCE_BUNDLE,
              "SpecialistTechSkillsCampaignOptionsChangedConfirmationDialog.description",
    ...
    private JPanel createButtonPanel() {
        ...
        RoundedJButton btnCancel = new RoundedJButton(getTextAt(RESOURCE_BUNDLE,
              "SpecialistTechSkillsCampaignOptionsChangedConfirmationDialog.cancel"));
        btnCancel.addActionListener(evt -> dispose());

        RoundedJButton btnConfirm = new RoundedJButton(getTextAt(RESOURCE_BUNDLE,
              "SpecialistTechSkillsCampaignOptionsChangedConfirmationDialog.confirm"));
        btnConfirm.addActionListener(evt -> {
            addMissingSpecialistSkills(campaign);
            dispose();
        });
    ...
    /**
     * Gives every technician in the campaign the supplemental specialist skills their profession expects, matched to
     * the level of their global tech skill. Non-technicians are left unchanged.
     *
     * @param campaign the campaign whose technicians are updated
     */
    public static void addMissingSpecialistSkills(Campaign campaign) {
