...
import static mekhq.campaign.universe.companyGeneration.SupportTOEFormationTypes.LOGISTICS_FORMATION;
...
public class StratConConvoyCampaignOptionsChangedConfirmationDialog extends JDialog {
    ...
    public static void processFreeUnits(Campaign campaign, Faction faction, boolean isAutomaticallyAssignRanks) {
        ...
        if (!units.isEmpty()) {
            AddSupportUnitsToTOE.addSupportUnitsToTOE(campaign, units, LOGISTICS_FORMATION);
        }
    }
}
