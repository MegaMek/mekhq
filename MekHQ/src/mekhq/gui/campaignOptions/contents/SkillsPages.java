...
public class SkillsPages {
    ...
    /**
     * Constructs a new {@code SkillsPages} instance and initializes the necessary data structures for managing skill
     * configurations.
     *
     * @param campaignOptions the {@code CampaignOptions} instance that holds the settings to be modified or displayed
     *                        in this page.
     */
    public SkillsPages(@Nonnull CampaignOptions campaignOptions) {
