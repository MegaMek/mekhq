...
/**
 * The {@code AbilitiesPages} class represents a GUI page for configuring and managing special abilities in a campaign.
...
public class AbilitiesPages {
    ...
    /**
     * Constructor for the {@code AbilitiesPages} class. Initializes the page by creating containers for ability categories
     * and populating them with related ability information.
     */
    public AbilitiesPages() {
        initialize();
    }
