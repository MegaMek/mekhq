...
class FinancesGeneralPage {
    ...
    private JPanel pnlATimeOfWarIncome;
    ...
    @Nonnull JPanel createPanel(@Nullable FinancesOptionsModel model) {
        ...
        pnlATimeOfWarIncome = createATimeOfWarIncomePanel();
        ...
        JPanel panel = CampaignOptionsPagePanel.builder("FinancesGeneralPage", "FinancesGeneralPage", imageAddress)
                ...
                .section("lblSharesPanel.text",
                        ...
                        pnlShares,
                        getMetadata(LEGACY_RULE_BEFORE_METADATA, CampaignOptionFlag.CUSTOM_SYSTEM))
                .section("lblATimeOfWarIncomePanel.text",
                        "lblATimeOfWarIncomePanel.summary",
                        pnlATimeOfWarIncome)
    ...
    /**
     * Creates and returns the A Time of War income panel, whose checkboxes toggle the monthly income and recruitment
     * generated by the campaign commander's Wealth, Connections, and Extra Income traits.
     *
     * @return a {@link JPanel} containing the configured A Time of War income options
     */
    private @Nonnull JPanel createATimeOfWarIncomePanel() {
        // Contents
