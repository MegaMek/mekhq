...
public class BiographyPages {
    ...
    private final GeneralPages generalPage;
     ...
     */
    public BiographyPages(@Nonnull Campaign campaign, GeneralPages generalPage) {
    ...
    private void configureEmbeddedRankSystemsPane() {
        ...
        rankSystemsPane.setColumnWidthProvider(BiographyPages::getEmbeddedRankColumnWidth);
