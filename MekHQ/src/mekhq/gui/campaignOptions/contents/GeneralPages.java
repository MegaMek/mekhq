...
public class GeneralPages {
    ...
    /**
     * Constructs a new instance of the {@code GeneralPages} using the provided {@link Campaign} and {@link JFrame}.
     *
     ...
     *                 triggered.
     */
    public GeneralPages(@Nonnull Campaign campaign, JFrame frame, CampaignOptionsDialogMode mode) {
