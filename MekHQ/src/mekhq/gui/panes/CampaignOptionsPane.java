...
public class CampaignOptionsPane extends AbstractMHQTabbedPane {
    ...
    // Morale
    private JPanel turnoverAndRetentionMoralePanel = new JPanel();
    ...
    private JLabel lblTheftResellValue;
    private JSpinner spnTheftResellValue;
    private JCheckBox chkUseTheftMoney;
    private JLabel lblTheftValue;
    private JSpinner spnTheftValue;
    private JCheckBox chkUseTheftParts;
    private JLabel lblTheftPartsDiceCount;
    private JSpinner spnTheftPartsDiceCount;
    ...
    private JLabel lblWarriorCasteAccidents;
    private JSpinner spnWarriorCasteAccidents;
    ...
    private JScrollPane createTurnoverAndRetentionTab() {
        ...
        gbc.gridx = 0;
        gbc.gridy++;
        turnoverAndRetentionPanel.add(createTurnoverAndRetentionMoralePanel(), gbc);
    ...
    private JPanel createTurnoverAndRetentionSettingsPanel() {
        ...
        chkUseRandomFounderRetirement.setEnabled(isUseTurnover);
    ...
    private JPanel createTurnoverAndRetentionMoralePanel() {
        chkUseMorale = new JCheckBox(resources.getString("chkUseMorale.text"));
        chkUseMorale.setToolTipText(resources.getString("chkUseMorale.toolTipText"));
        chkUseMorale.setName("chkUseMorale");
        chkUseMorale.addActionListener(evt -> {
            final boolean isEnabled = chkUseMorale.isSelected();

            // General Handlers
            for (Component component : moraleSubPanel.getComponents()) {
                component.setEnabled(isEnabled);
            }

            for (Component component : turnoverAndRetentionMoraleModifiersPanel.getComponents()) {
                component.setEnabled(isEnabled);
            }
            ...
            lblTheftResellValue.setEnabled((isEnabled) && ((chkUseDesertions.isSelected()) || (chkUseMutinies.isSelected())));
            spnTheftResellValue.setEnabled((isEnabled) && ((chkUseDesertions.isSelected()) || (chkUseMutinies.isSelected())));
            chkUseTheftMoney.setEnabled((isEnabled) && ((chkUseDesertions.isSelected()) || (chkUseMutinies.isSelected())));
            lblTheftValue.setEnabled((isEnabled) && ((chkUseDesertions.isSelected()) || (chkUseMutinies.isSelected())));
            spnTheftValue.setEnabled((isEnabled) && ((chkUseDesertions.isSelected()) || (chkUseMutinies.isSelected())));
            chkUseTheftParts.setEnabled((isEnabled) && ((chkUseDesertions.isSelected()) || (chkUseMutinies.isSelected())));
            lblTheftPartsDiceCount.setEnabled((isEnabled) && ((chkUseDesertions.isSelected()) || (chkUseMutinies.isSelected())));
            spnTheftPartsDiceCount.setEnabled((isEnabled) && ((chkUseDesertions.isSelected()) || (chkUseMutinies.isSelected())));
        });

        createMoraleSubPanel();

        turnoverAndRetentionMoralePanel = new JDisableablePanel("turnoverAndRetentionMoralePanel");
        turnoverAndRetentionMoralePanel.setBorder(BorderFactory.createTitledBorder(resources.getString("turnoverAndRetentionMoralePanel.title")));

        final GroupLayout layout = new GroupLayout(turnoverAndRetentionMoralePanel);
        turnoverAndRetentionMoralePanel.setLayout(layout);
        layout.setAutoCreateGaps(true);
        layout.setAutoCreateContainerGaps(true);

        layout.setVerticalGroup(
                layout.createSequentialGroup()
                        .addComponent(chkUseMorale)
                        .addComponent(moraleSubPanel)
        );
        ...
        return turnoverAndRetentionMoralePanel;
    }
    ...
    private void createMoraleSubPanel() {
        ...
        lblForceReliabilityMethod.setEnabled(isUseMorale);

        comboForceReliabilityMethod = new MMComboBox<>("comboForceReliabilityMethod", ForceReliabilityMethod.values());
        comboForceReliabilityMethod.setToolTipText(resources.getString("lblForceReliabilityMethod.toolTipText"));
        comboForceReliabilityMethod.setEnabled(isUseMorale);
        comboForceReliabilityMethod.setRenderer(new DefaultListCellRenderer() {
            @Override
            public Component getListCellRendererComponent(final JList<?> list, final Object value,
                                                          final int index, final boolean isSelected,
                                                          final boolean cellHasFocus) {
                super.getListCellRendererComponent(list, value, index, isSelected, cellHasFocus);
                if (value instanceof ForceReliabilityMethod) {
                    list.setToolTipText(((ForceReliabilityMethod) value).getToolTipText());
                }
                return this;
            }
        });

        lblMutinyMethod = new JLabel(resources.getString("lblMutinyMethod.text"));
        lblMutinyMethod.setToolTipText(resources.getString("lblMutinyMethod.toolTipText"));
        lblMutinyMethod.setName("lblMutinyMethod");
        lblMutinyMethod.setEnabled((isUseMorale) && (campaign.getCampaignOptions().isUseMutinies()));

        comboMutinyMethod = new MMComboBox<>("comboMutinyMethod", MutinyMethod.values());
        comboMutinyMethod.setToolTipText(resources.getString("lblMutinyMethod.toolTipText"));
        comboMutinyMethod.setEnabled((isUseMorale) && (campaign.getCampaignOptions().isUseMutinies()));
        comboMutinyMethod.setRenderer(new DefaultListCellRenderer() {
            @Override
            public Component getListCellRendererComponent(final JList<?> list, final Object value,
                                                          final int index, final boolean isSelected,
                                                          final boolean cellHasFocus) {
                super.getListCellRendererComponent(list, value, index, isSelected, cellHasFocus);
                if (value instanceof MutinyMethod) {
                    list.setToolTipText(((MutinyMethod) value).getToolTipText());
                }
                return this;
            }
        });
        ...
        chkUseDesertions.setEnabled(isUseMorale);
        ...
        chkUseTheftUnit.setEnabled(isUseMorale);

        lblTheftResellValue = new JLabel(resources.getString("lblTheftResellValue.text"));
        lblTheftResellValue.setToolTipText(resources.getString("lblTheftResellValue.toolTipText"));
        lblTheftResellValue.setName("lblTheftResellValue");
        lblTheftResellValue.setEnabled(isUseMorale);

        spnTheftResellValue = new JSpinner(new SpinnerNumberModel(50, 1, 100, 1));
        spnTheftResellValue.setToolTipText(resources.getString("lblTheftResellValue.toolTipText"));
        spnTheftResellValue.setName("spnTheftResellValue");
        spnTheftResellValue.setEnabled(isUseMorale);
        ...
        chkUseTheftMoney.setEnabled(isUseMorale);
        ...
        lblTheftValue.setEnabled(isUseMorale);
        ...
        spnTheftValue.setEnabled(isUseMorale);

        chkUseTheftParts = new JCheckBox(resources.getString("chkUseTheftParts.text"));
        chkUseTheftParts.setToolTipText(resources.getString("chkUseTheftParts.toolTipText"));
        chkUseTheftParts.setName("chkUseTheftParts");
        chkUseTheftParts.setEnabled(isUseMorale);

        lblTheftPartsDiceCount = new JLabel(resources.getString("lblTheftPartsDiceCount.text"));
        lblTheftPartsDiceCount.setToolTipText(resources.getString("lblTheftPartsDiceCount.toolTipText"));
        lblTheftPartsDiceCount.setName("lblTheftPartsDiceCount");
        lblTheftPartsDiceCount.setEnabled(isUseMorale);

        spnTheftPartsDiceCount = new JSpinner(new SpinnerNumberModel(1, 0, 3, 1));
        spnTheftPartsDiceCount.setToolTipText(resources.getString("lblTheftPartsDiceCount.toolTipText"));
        spnTheftPartsDiceCount.setName("spnTheftPartsDiceCount");
        spnTheftPartsDiceCount.setEnabled(isUseMorale);

        moraleSubPanel.setName("moraleSubPanel");
        moraleSubPanel.setBorder(BorderFactory.createTitledBorder(""));
        moraleSubPanel.setEnabled(isUseMorale);

        final GroupLayout layout = new GroupLayout(moraleSubPanel);
        moraleSubPanel.setLayout(layout);
        layout.setAutoCreateGaps(true);
        layout.setAutoCreateContainerGaps(true);
        ...
        layout.setVerticalGroup(
                layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(Alignment.BASELINE)
                                ...
                                .addComponent(spnTheftResellValue, Alignment.LEADING))
                        .addComponent(chkUseTheftMoney)
                        .addGroup(layout.createParallelGroup(Alignment.BASELINE)
                                .addComponent(spnTheftValue)
                                .addComponent(lblTheftValue, Alignment.LEADING))
                        .addComponent(chkUseTheftParts)
                        .addGroup(layout.createParallelGroup(Alignment.BASELINE)
                                        .addComponent(lblTheftPartsDiceCount)
                                        .addComponent(spnTheftPartsDiceCount, Alignment.LEADING))
        );
        ...
        layout.setHorizontalGroup(
                layout.createParallelGroup(Alignment.LEADING)
                        ...
                        .addGroup(layout.createSequentialGroup()
                                .addComponent(lblTheftPartsDiceCount)
                                .addComponent(spnTheftPartsDiceCount))
        );
    }

    private JPanel createTurnoverAndRetentionMoraleModifiersPanel() {
        boolean isUseMorale = campaign.getCampaignOptions().isUseMorale();

        lblCustomMoraleModifier = new JLabel(resources.getString("lblCustomMoraleModifier.text"));
        lblCustomMoraleModifier.setToolTipText(resources.getString("lblCustomMoraleModifier.toolTipText"));
        lblCustomMoraleModifier.setName("lblCustomMoraleModifier");
        lblCustomMoraleModifier.setEnabled(isUseMorale);

        spnCustomMoraleModifier = new JSpinner(new SpinnerNumberModel(0, -10, 10, 1));
        ...
        chkUseMoraleModifierProfession.setName("chkUseMoraleModifierProfession");
        chkUseMoraleModifierProfession.setEnabled(isUseMorale);

        chkUseMoraleModifierForceReliability = new JCheckBox(resources.getString("chkUseMoraleModifierForceReliability.text"));
        chkUseMoraleModifierForceReliability.setToolTipText(resources.getString("chkUseMoraleModifierForceReliability.toolTipText"));
        ...
        turnoverAndRetentionMoraleModifiersPanel.setEnabled(isUseMorale);

        final GroupLayout layout = new GroupLayout(turnoverAndRetentionMoraleModifiersPanel);
        turnoverAndRetentionMoraleModifiersPanel.setLayout(layout);
        layout.setAutoCreateGaps(true);
        layout.setAutoCreateContainerGaps(true);
    ...
    private JPanel createEducationPanel() {
        ...
        layout.setVerticalGroup(
                layout.createSequentialGroup()
                        ...
                        .addComponent(warriorCasteFallbackPanel)
        );
    ...
    private JPanel createStandardSetsPanel() {
        ...
        chkEnablePrestigiousAcademies = new JCheckBox(resources.getString("chkEnablePrestigiousAcademies.text"));
        ...
        chkEnableClanEducation = new JCheckBox(resources.getString("chkEnableClanEducation.text"));
        ...
        layout.setVerticalGroup(
                layout.createParallelGroup(Alignment.LEADING)
                        ...
                        .addComponent(chkEnableClanEducation)
        );
                ...
                layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(Alignment.BASELINE)
                                ...
                                .addGroup(layout.createParallelGroup(Alignment.BASELINE)
                                        ...
                                        .addComponent(spnChildrenDropoutChance, Alignment.LEADING)))
                        .addGroup(layout.createParallelGroup(Alignment.BASELINE)
    ...
    private JPanel createAccidentsAndEventsPanel() {
        ...
        chkLiveFireBlooding.setName("chkLiveFireBlooding");
        ...
        layout.setVerticalGroup(
                layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(Alignment.BASELINE)
                                ...
                                .addComponent(chkLiveFireBlooding))
                        .addGroup(layout.createParallelGroup(Alignment.BASELINE)
                                .addComponent(lblMilitaryAcademyAccidents)
                                .addComponent(spnMilitaryAcademyAccidents, Alignment.LEADING))
                        .addGroup(layout.createParallelGroup(Alignment.BASELINE)
                                .addComponent(lblWarriorCasteAccidents)
                                .addComponent(spnWarriorCasteAccidents, Alignment.LEADING)
                                .addGroup(layout.createParallelGroup(Alignment.BASELINE)
                                        .addComponent(lblOtherCasteAccidents)
                                        .addComponent(spnOtherCasteAccidents, Alignment.LEADING)))
        );
        ...
        layout.setHorizontalGroup(
                layout.createParallelGroup(Alignment.LEADING)
                        ...
                        .addGroup(layout.createSequentialGroup()
                                .addComponent(lblWarriorCasteAccidents)
                                .addComponent(spnWarriorCasteAccidents)
                                .addGroup(layout.createSequentialGroup()
                                        .addComponent(lblOtherCasteAccidents)
                                        .addComponent(spnOtherCasteAccidents)))
        );
    ...
    private JPanel createWarriorCasteFallbackPanel() {
        ...
        // creating the layout
        final JPanel panel = new JPanel();
        panel.setBorder(BorderFactory.createTitledBorder(resources.getString("warriorCasteFallbackCastes.title")));
        panel.setName("warriorCasteFallbackPanel");
        ...
        layout.setVerticalGroup(
                layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(Alignment.BASELINE)
                                ...
                                .addGroup(layout.createParallelGroup(Alignment.BASELINE)
                                        .addComponent(lblFallbackMerchant)
                                        .addComponent(spnFallbackMerchant, Alignment.LEADING)))
                        .addGroup(layout.createParallelGroup(Alignment.BASELINE)
        ...
        layout.setHorizontalGroup(
                layout.createParallelGroup(Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createSequentialGroup()
                                        .addComponent(lblFallbackMerchant)
                                        .addComponent(spnFallbackMerchant)))
                        .addGroup(layout.createSequentialGroup()
                                .addComponent(lblFallbackTechnician)
    ...
    public void setOptions(@Nullable CampaignOptions options,
        ...
        chkUseTheftParts.setSelected(options.isUseTheftParts());
        spnTheftPartsDiceCount.setValue(options.getTheftPartsDiceCount());
    ...
    public void updateOptions() {
        try {
            ...
            options.setUseTheftParts(chkUseTheftParts.isSelected());
            options.setTheftPartsDiceCount((Integer) spnTheftPartsDiceCount.getValue());
