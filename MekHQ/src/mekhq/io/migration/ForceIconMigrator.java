...
public class ForceIconMigrator {
    ...
    private static void migrateAdjustments(final LayeredForceIcon original, final LayeredForceIcon migrated) {
        for (final ForcePieceIcon piece : original.getPieces().getOrDefault(LayeredForceIconLayer.ADJUSTMENT, new ArrayList<>())) {
            switch (piece.getFilename()) {
                ...
                case "Artillery_Missile_small.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ADJUSTMENT, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ADJUSTMENT)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ADJUSTMENT, "NATO/", "Artillery (Missile).png"));
                    break;
                case "Artillery_Missile_Multiple.png":
                case "Artillery_Missile_Multiple_small.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ADJUSTMENT, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ADJUSTMENT)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ADJUSTMENT, "NATO/", "Artillery (Multiple Missile).png"));
                    break;
                ...
                case "Infantry_Jumppng":
                    migrated.getPieces().put(LayeredForceIconLayer.ADJUSTMENT, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ADJUSTMENT)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ADJUSTMENT, "StratOps/", "Jump Infantry (Large).png"));
                    break;
    ...
    private static void migrateAlphanumerics(final LayeredForceIcon original, final LayeredForceIcon migrated) {
        for (final ForcePieceIcon piece : original.getPieces().getOrDefault(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>())) {
            switch (piece.getFilename()) {
                case "A I Low.png":
                    ...
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Left/English Letters/", "A.png"));
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Right/Roman Numerals/", "(01) Roman I.png"));
                    break;
                case "A II Low.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Left/English Letters/", "A.png"));
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Right/Roman Numerals/", "(02) Roman II.png"));
                    break;
                case "A III Low.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Left/English Letters/", "A.png"));
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Right/Roman Numerals/", "(03) Roman III.png"));
                    break;
                case "A IV Low.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Left/English Letters/", "A.png"));
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Right/Roman Numerals/", "(04) Roman IV.png"));
                    break;
                case "A V Low.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Left/English Letters/", "A.png"));
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Right/Roman Numerals/", "(05) Roman V.png"));
                    break;
                case "B I Low.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Left/English Letters/", "B.png"));
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Right/Roman Numerals/", "(01) Roman I.png"));
                    break;
                case "B II Low.png":
                ...
                case "C I Low.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Left/English Letters/", "C.png"));
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Right/Roman Numerals/", "(01) Roman I.png"));
                    break;
                case "C II Low.png":
                ...
                case "D I Low.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Left/English Letters/", "D.png"));
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Right/Roman Numerals/", "(01) Roman I.png"));
                    break;
                case "D II Low.png":
                ...
                case "E I Low.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Left/English Letters/", "E.png"));
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Right/Roman Numerals/", "(01) Roman I.png"));
                    break;
                case "E II Low.png":
                ...
                case "F I Low.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Left/English Letters/", "F.png"));
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Right/Roman Numerals/", "(01) Roman I.png"));
                    break;
                case "F II Low.png":
                ...
                case "G I Low.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Left/English Letters/", "G.png"));
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Right/Roman Numerals/", "(01) Roman I.png"));
                    break;
                case "G II Low.png":
                ...
                case "B.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Right/English Letters/", "B.png"));
                    break;
                case "BB.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                ...
                case "C.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Right/English Letters/", "C.png"));
                    break;
                case "CA.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                ...
                case "D.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Right/English Letters/", "D.png"));
                    break;
                case "DCV.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                ...
                case "E.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Right/English Letters/", "E.png"));
                    break;
                case "EP.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                ...
                case "F.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Right/English Letters/", "F.png"));
                    break;
                case "FR.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                ...
                case "G.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Right/English Letters/", "G.png"));
                    break;
                case "H Low Left.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Left/English Letters/", "H.png"));
                    break;
                case "H Low.png":
                case "H.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                ...
                case "I Low Left.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Left/English Letters/", "I.png"));
                    break;
                case "I Low.png":
                case "I.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Right/English Letters/", "I.png"));
                    break;
                case "II Low.png":
                case "II.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                ...
                case "IX.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Right/Roman Numerals/", "(09) Roman IX.png"));
                    break;
                case "J Low Left.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Left/English Letters/", "J.png"));
                    break;
                case "J Low.png":
                case "J.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Right/English Letters/", "J.png"));
                    break;
                case "K Low Left.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Left/English Letters/", "K.png"));
                    break;
                case "K Low.png":
                case "K.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Right/English Letters/", "K.png"));
                    break;
                case "L Low Left.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Left/English Letters/", "L.png"));
                    break;
                case "L Low.png":
                case "L.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                ...
                case "M Low Left.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Left/English Letters/", "M.png"));
                    break;
                case "M Low.png":
                case "M.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                ...
                case "N Low Left.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Left/English Letters/", "N.png"));
                    break;
                case "N Low.png":
                case "N.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Right/English Letters/", "N.png"));
                    break;
                case "NF.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                ...
                case "O Low Left.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Left/English Letters/", "O.png"));
                    break;
                case "O Low.png":
                case "O.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Right/English Letters/", "O.png"));
                    break;
                case "P Low Left.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Left/English Letters/", "P.png"));
                    break;
                case "P Low.png":
                case "P.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Right/English Letters/", "P.png"));
                    break;
                case "PC.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                ...
                case "Q Low Left.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Left/English Letters/", "Q.png"));
                    break;
                case "Q Low.png":
                case "Q.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Right/English Letters/", "Q.png"));
                    break;
                case "R Low Left.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Left/English Letters/", "R.png"));
                    break;
                case "R Low.png":
                case "R.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Right/English Letters/", "R.png"));
                    break;
                case "S Low Left.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Left/English Letters/", "S.png"));
                    break;
                case "S Low.png":
                case "S.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Right/English Letters/", "S.png"));
                    break;
                case "SB.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                ...
                case "T Low Left.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Left/English Letters/", "T.png"));
                    break;
                case "T Low.png":
                case "T.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Right/English Letters/", "T.png"));
                    break;
                case "U Low Left.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Left/English Letters/", "U.png"));
                    break;
                case "U Low.png":
                case "U.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Right/English Letters/", "U.png"));
                    break;
                case "V Low Left.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Left/English Letters/", "V.png"));
                    break;
                case "V Low.png":
                case "V.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Right/English Letters/", "V.png"));
                    break;
                case "VI Low.png":
                case "VI.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Right/Roman Numerals/", "(06) Roman VI.png"));
                    break;
                case "VII Low.png":
                case "VII.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Right/Roman Numerals/", "(07) Roman VII.png"));
                    break;
                case "VIII Low.png":
                case "VIII.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Right/Roman Numerals/", "(08) Roman VIII.png"));
                    break;
                case "W Low Left.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Left/English Letters/", "W.png"));
                    break;
                case "W Low.png":
                case "W.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Right/English Letters/", "W.png"));
                    break;
                case "X Low Left.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Left/English Letters/", "X.png"));
                    break;
                case "X Low.png":
                case "X.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Right/English Letters/", "X.png"));
                    break;
                case "Y Low Left.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Left/English Letters/", "Y.png"));
                    break;
                case "Y Low.png":
                case "Y.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Right/English Letters/", "Y.png"));
                    break;
                case "YC.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                ...
                case "Z Low Left.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Left/English Letters/", "Z.png"));
                    break;
                case "Z Low.png":
                case "Z.png":
                    migrated.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Right/English Letters/", "Z.png"));
                    break;
                default:
                    break;
            }
    ...
    private static void migrateBackgrounds(final LayeredForceIcon original, final LayeredForceIcon migrated) {
        for (final ForcePieceIcon piece : original.getPieces().getOrDefault(LayeredForceIconLayer.BACKGROUND, new ArrayList<>())) {
            switch (piece.getFilename()) {
                case "CDS.png":
                    ...
                    migrated.getPieces().get(LayeredForceIconLayer.BACKGROUND)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.BACKGROUND, "Clan/", "Clan Diamond Shark.png"));
                    break;
                case "CGB.png":
                    migrated.getPieces().put(LayeredForceIconLayer.BACKGROUND, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.BACKGROUND)
                ...
                case "CHH.png":
                    migrated.getPieces().put(LayeredForceIconLayer.BACKGROUND, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.BACKGROUND)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.BACKGROUND, "Clan/", "Clan Hell's Horses.png"));
                    break;
                case "CJF.png":
                    migrated.getPieces().put(LayeredForceIconLayer.BACKGROUND, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.BACKGROUND)
                ...
                case "CNC Alternate.png":
                    migrated.getPieces().put(LayeredForceIconLayer.BACKGROUND, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.BACKGROUND)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.BACKGROUND, "Clan/", "Clan Nova Cat (Alternate).png"));
                    break;
                case "CNC.png":
                    migrated.getPieces().put(LayeredForceIconLayer.BACKGROUND, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.BACKGROUND)
                ...
                case "CSR Alternate.png":
                    migrated.getPieces().put(LayeredForceIconLayer.BACKGROUND, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.BACKGROUND)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.BACKGROUND, "Clan/", "Clan Snow Raven (Alternate).png"));
                    break;
                case "CSR.png":
                    migrated.getPieces().put(LayeredForceIconLayer.BACKGROUND, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.BACKGROUND)
                ...
                case "Draconis Combine.png":
                    migrated.getPieces().put(LayeredForceIconLayer.BACKGROUND, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.BACKGROUND)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.BACKGROUND, "Inner Sphere/", "Draconis Combine.png"));
                    break;
                case "Federated Suns.png":
                    migrated.getPieces().put(LayeredForceIconLayer.BACKGROUND, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.BACKGROUND)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.BACKGROUND, "Inner Sphere/", "Federated Suns.png"));
                    break;
                case "Free Rasalhague Republic.png":
                    migrated.getPieces().put(LayeredForceIconLayer.BACKGROUND, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.BACKGROUND)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.BACKGROUND, "Inner Sphere/", "Free Rasalhague Republic.png"));
                    break;
                case "Free Worlds League.png":
                    migrated.getPieces().put(LayeredForceIconLayer.BACKGROUND, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.BACKGROUND)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.BACKGROUND, "Inner Sphere/", "Free Worlds League.png"));
                    break;
                case "Lyran Commonwealth.png":
                    migrated.getPieces().put(LayeredForceIconLayer.BACKGROUND, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.BACKGROUND)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.BACKGROUND, "Inner Sphere/", "Lyran Commonwealth.png"));
                    break;
                case "Republic of the sphere.png":
                    migrated.getPieces().put(LayeredForceIconLayer.BACKGROUND, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.BACKGROUND)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.BACKGROUND, "Inner Sphere/", "Republic of the Sphere.png"));
                    break;
                case "Magistracy of Canopus alternate.png":
                    migrated.getPieces().put(LayeredForceIconLayer.BACKGROUND, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.BACKGROUND)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.BACKGROUND, "Periphery/", "Magistracy of Canopus (Alternate).png"));
                    break;
                case "Magistracy of Canopus.png":
                    migrated.getPieces().put(LayeredForceIconLayer.BACKGROUND, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.BACKGROUND)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.BACKGROUND, "Periphery/", "Magistracy of Canopus.png"));
                    break;
                case "Marian Hegemony.png":
                    migrated.getPieces().put(LayeredForceIconLayer.BACKGROUND, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.BACKGROUND)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.BACKGROUND, "Periphery/", "Marian Hegemony.png"));
                    break;
                case "Outworlds alliance alternate.png":
                    migrated.getPieces().put(LayeredForceIconLayer.BACKGROUND, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.BACKGROUND)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.BACKGROUND, "Periphery/", "Outworlds Alliance (Alternate).png"));
                    break;
                case "Outworlds alliance.png":
                    migrated.getPieces().put(LayeredForceIconLayer.BACKGROUND, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.BACKGROUND)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.BACKGROUND, "Periphery/", "Outworlds Alliance.png"));
                    break;
                case "Rim worlds Republic.png":
                    migrated.getPieces().put(LayeredForceIconLayer.BACKGROUND, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.BACKGROUND)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.BACKGROUND, "Periphery/", "Rim Worlds Republic.png"));
                    break;
                case "Tarurian Concordat .png":
                    migrated.getPieces().put(LayeredForceIconLayer.BACKGROUND, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.BACKGROUND)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.BACKGROUND, "Periphery/", "Taurian Concordat.png"));
                    break;
                case "Tarurian Concordat alternate.png":
                    migrated.getPieces().put(LayeredForceIconLayer.BACKGROUND, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.BACKGROUND)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.BACKGROUND, "Periphery/", "Taurian Concordat (Alternate).png"));
                    break;
                case "Merc.png":
                    migrated.getPieces().put(LayeredForceIconLayer.BACKGROUND, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.BACKGROUND)
    ...
    private static void migrateFormations(final LayeredForceIcon original, final LayeredForceIcon migrated) {
        for (final ForcePieceIcon piece : original.getPieces().getOrDefault(LayeredForceIconLayer.FORMATION, new ArrayList<>())) {
            switch (piece.getFilename()) {
                case "00 Installation.png":
                    ...
                    migrated.getPieces().get(LayeredForceIconLayer.FORMATION)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.FORMATION, "Inner Sphere/", "(00) Installation.png"));
                    break;
                case "01 Fire Team.png":
                case "01 FireTeam.png":
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.FORMATION, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.FORMATION)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.FORMATION, "Inner Sphere/", "(01) Fire Team.png"));
                    break;
                case "02 Individual.png":
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.FORMATION, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.FORMATION)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.FORMATION, "Inner Sphere/", "(02) Individual.png"));
                    break;
                case "03 Team.png":
                case "03Team.png":
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.FORMATION, new ArrayList<>());
                ...
                case "05 Lance Augmented.png":
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.FORMATION, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.FORMATION)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.FORMATION, "Inner Sphere/", "(04A) Augmented Lance.png"));
                    break;
                case "06 Company.png":
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.FORMATION, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.FORMATION)
                ...
                case "07 Company Task Force.png":
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.FORMATION, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.FORMATION)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.FORMATION, "Inner Sphere/", "(05A) Company Task Force.png"));
                    break;
                case "08 Battalion.png":
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.FORMATION, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.FORMATION)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.FORMATION, "Inner Sphere/", "(06) Battalion.png"));
                    break;
                case "09 Battlegroup.png":
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.FORMATION, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.FORMATION)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.FORMATION, "Inner Sphere/", "(06A) Battlegroup.png"));
                    break;
                case "10 Regiment.png":
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.FORMATION, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.FORMATION)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.FORMATION, "Inner Sphere/", "(07) Regiment.png"));
                    break;
                case "11 Brigade.png":
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.FORMATION, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.FORMATION)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.FORMATION, "Inner Sphere/", "(09) Brigade.png"));
                    break;
                case "12 Division.png":
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.FORMATION, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.FORMATION)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.FORMATION, "Inner Sphere/", "(09) Division.png"));
                    break;
                case "13 Corps.png":
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.FORMATION, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.FORMATION)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.FORMATION, "Inner Sphere/", "(10) Corps.png"));
                    break;
                case "14 Field Army.png":
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.FORMATION, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.FORMATION)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.FORMATION, "Inner Sphere/", "(11) Field Army.png"));
                    break;
                case "15 Army Group.png":
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.FORMATION, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.FORMATION)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.FORMATION, "Inner Sphere/", "(12) Army Group.png"));
                    break;
                case "Brigade Augmented.png":
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.FORMATION, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.FORMATION)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.FORMATION, "Inner Sphere/", "(08A) Augmented Brigade.png"));
                    break;
                case "Corps Augmented.png":
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.FORMATION, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.FORMATION)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.FORMATION, "Inner Sphere/", "(10A) Augmented Corps.png"));
                    break;
                case "Division Augmented.png":
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.FORMATION, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.FORMATION)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.FORMATION, "Inner Sphere/", "(09A) Augmented Division.png"));
                    break;
                case "Field Army Augmented.png":
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.FORMATION, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.FORMATION)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.FORMATION, "Inner Sphere/", "(11A) Augmented Field Army.png"));
                    break;
                case "Regiment Augmented.png":
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.FORMATION, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.FORMATION)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.FORMATION, "Inner Sphere/", "(07A) Augmented Regiment.png"));
                    break;
                case "16 Level I.png":
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.FORMATION, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.FORMATION)
                ...
                case "28 SuperNova Binary.png":
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.FORMATION, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.FORMATION)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.FORMATION, "Clan/", "(05) SuperNova Binary.png"));
                    break;
                case "29 SuperNova Trinary.png":
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.FORMATION, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.FORMATION)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.FORMATION, "Clan/", "(07) SuperNova Trinary.png"));
                    break;
                case "30 Cluster.png":
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.FORMATION, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.FORMATION)
    ...
    private static void migrateLogos(final LayeredForceIcon original, final LayeredForceIcon migrated) {
        for (final ForcePieceIcon piece : original.getPieces().getOrDefault(LayeredForceIconLayer.LOGO, new ArrayList<>())) {
            switch (piece.getFilename()) {
                case "Capellan Confederation.png":
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.LOGO, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.LOGO)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.LOGO, "Inner Sphere/", "Capellan Confederation.png"));
                    break;
                case "ComStar.png":
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.LOGO, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.LOGO)
                ...
                case "Federated Commonwealth.png":
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.LOGO, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.LOGO)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.LOGO, "Inner Sphere/", "Federated Commonwealth.png"));
                    break;
                case "Federated Suns.png":
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.LOGO, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.LOGO)
                ...
                case "Free Rasalhague Republic.png":
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.LOGO, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.LOGO)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.LOGO, "Inner Sphere/", "Free Rasalhague Republic.png"));
                    break;
                case "Free Worlds League.png":
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.LOGO, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.LOGO)
                ...
                case "Lyran Commonwealth.png":
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.LOGO, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.LOGO)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.LOGO, "Inner Sphere/", "Lyran Commonwealth.png"));
                    break;
                case "Rim Worlds Republic.png":
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.LOGO, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.LOGO)
    ...
    private static void migrateSpecialModifiers(final LayeredForceIcon original, final LayeredForceIcon migrated) {
        for (final ForcePieceIcon piece : original.getPieces().getOrDefault(LayeredForceIconLayer.SPECIAL_MODIFIER, new ArrayList<>())) {
            switch (piece.getFilename()) {
                case "C3.png":
    ...
    private static void migrateTypes(final LayeredForceIcon original, final LayeredForceIcon migrated) {
        for (final ForcePieceIcon piece : original.getPieces().getOrDefault(LayeredForceIconLayer.TYPE, new ArrayList<>())) {
            switch (piece.getFilename()) {
                ...
                case "Aviation VTOL.png":
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.TYPE, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "NATO/", "Aviation, Rotary Wing (Civilian).png"));
                    break;
                ...
                case "Drone Hover Converted.png":
                    ...
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.ADJUSTMENT, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ADJUSTMENT)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ADJUSTMENT, "NATO/", "Drone (Converted).png"));
                    break;
                ...
                case "Fixed Wing.png":
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.TYPE, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "NATO/", "Aviation, Fixed Wing (Civilian).png"));
                    break;
                case "Headquarters.png":
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.TYPE, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Type/", "HQ (Headquarters).png"));
                    break;
                ...
                case "Infantry Jump.png":
                    ...
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.ADJUSTMENT, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ADJUSTMENT)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ADJUSTMENT, "NATO/", "Jump Infantry (Large).png"));
                    break;
                case "Infantry Mechanized VTOL.png":
                    ...
                    migrated.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "NATO/", "Infantry.png"));
                    migrated.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "NATO/", "Aviation, Rotary Wing (Military).png"));
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.ADJUSTMENT, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.ADJUSTMENT)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ADJUSTMENT, "NATO/", "Mechanized.png"));
                    break;
                ...
                case "Rail Unpressurized.png":
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.TYPE, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "StratOps/", "Rail (Unpressurized).png"));
                    break;
                case "Satellite.png":
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.TYPE, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.TYPE)
                ...
                case "WIGE.png":
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.TYPE, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "NATO/", "Aviation, WiGE (Military).png"));
                    break;
                case "Xenoplanetary.png":
                    migrated.getPieces().putIfAbsent(LayeredForceIconLayer.TYPE, new ArrayList<>());
                    migrated.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "StratOps/", "Infantry (Xenoplanetary).png"));
                    break;
                default:
                    break;
            }
    ...
    private static StandardForceIcon migrateStandardAerospace(final StandardForceIcon icon) {
        ...
        switch (icon.getFilename()) {
            ...
            case "afighter.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "NATO/", "Aviation, Fixed Wing (Military).png"));
    ...
    private static StandardForceIcon migrateStandardFormationsGreekLetters(final StandardForceIcon icon) {
        ...
        switch (icon.getFilename()) {
            case "Alpha.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Greek Alphabet/", "(01) ALPHA.png"));
                return layered;
            case "Beta.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Greek Alphabet/", "(02) BETA.png"));
                return layered;
            case "Chi.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Greek Alphabet/", "(22) CHI.png"));
                return layered;
            case "Delta.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Greek Alphabet/", "(04) DELTA.png"));
                return layered;
            case "Epsilon.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Greek Alphabet/", "(05) EPSILON.png"));
                return layered;
            case "Epsilon_Icon.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Greek Letters/Upper Case/", "(05) Epsilon.png"));
                return layered;
            case "Eta.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Greek Alphabet/", "(07) ETA.png"));
                return layered;
            case "Gamma.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Greek Alphabet/", "(03) GAMMA.png"));
                return layered;
            case "Iota.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Greek Alphabet/", "(09) IOTA.png"));
                return layered;
            case "Iota_Icon.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Greek Letters/Upper Case/", "(09) Iota.png"));
                return layered;
            case "Kappa.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Greek Alphabet/", "(10) KAPPA.png"));
                return layered;
            case "Lambda.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Greek Alphabet/", "(11) LAMBDA.png"));
                return layered;
            case "Lambda_Icon.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Greek Letters/Upper Case/", "(11) Lambda.png"));
                return layered;
            case "Mu.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Greek Alphabet/", "(12) MU.png"));
                return layered;
            case "Mu_Icon.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Greek Letters/Upper Case/", "(12) Mu.png"));
                return layered;
            case "Nu.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Greek Alphabet/", "(13) NU.png"));
                return layered;
            case "Omega.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Greek Alphabet/", "(24) OMEGA.png"));
                return layered;
            case "Omega_Icon.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Greek Letters/Upper Case/", "(15) Omicron.png"));
                return layered;
            case "Omicron.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Greek Alphabet/", "(15) OMICRON.png"));
                return layered;
            case "Phi.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Greek Alphabet/", "(21) PHI.png"));
                return layered;
            case "Pi.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Greek Alphabet/", "(16) PI.png"));
                return layered;
            case "Pi_Icon.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Greek Letters/Upper Case/", "(16) Pi.png"));
                return layered;
            case "Psi.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Greek Alphabet/", "(23) PSI.png"));
                return layered;
            case "Psi_Icon.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Greek Letters/Upper Case/", "(23) Psi.png"));
                return layered;
            case "Rho.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Greek Alphabet/", "(17) RHO.png"));
                return layered;
            case "Rho_Icon.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Greek Letters/Upper Case/", "(17) Rho.png"));
                return layered;
            case "Sigma.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Greek Alphabet/", "(18) SIGMA.png"));
                return layered;
            case "Tau.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Greek Alphabet/", "(19) TAU.png"));
                return layered;
            case "Theta.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Greek Alphabet/", "(08) THETA.png"));
                return layered;
            case "Theta_Icon.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Greek Letters/Upper Case/", "(08) Theta.png"));
                return layered;
            case "Upsilon.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Greek Alphabet/", "(20) UPSILON.png"));
                return layered;
            case "Xi.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Greek Alphabet/", "(14) XI.png"));
                return layered;
            case "Xi_Icon.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Greek Letters/Upper Case/", "(14) Xi.png"));
                return layered;
            case "Zeta.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Greek Alphabet/", "(06) ZETA.png"));
                return layered;
            case "Zeta_Icon.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Greek Letters/Upper Case/", "(06) Zeta.png"));
                return layered;
            default:
                return icon;
        }
    ...
    private static StandardForceIcon migrateStandardFormationsIS(final StandardForceIcon icon) {
        ...
        switch (icon.getFilename()) {
            case "battalion.png":
                layered.getPieces().put(LayeredForceIconLayer.FORMATION, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.FORMATION)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.FORMATION, "Inner Sphere/", "(08) Battalion.png"));
                return layered;
            case "Level I.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Roman Numerals/", "(01) Roman I.png"));
                return layered;
            case "Level II.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Roman Numerals/", "(02) Roman II.png"));
                return layered;
            case "Level III.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Roman Numerals/", "(03) Roman III.png"));
                return layered;
            case "Level IV.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Roman Numerals/", "(04) Roman IV.png"));
                return layered;
            case "regiment.png":
                layered.getPieces().put(LayeredForceIconLayer.FORMATION, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.FORMATION)
    ...
    private static StandardForceIcon migrateStandardMilitary(final StandardForceIcon icon) {
        ...
        switch (icon.getFilename()) {
            case "Anti Air Arty.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Type/", "AAA (Anti-Aircraft Artillery).png"));
                return layered;
            case "Anti Air.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Type/", "AA (Anti-Aircraft).png"));
                return layered;
            case "Battalion.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Order of Battle/", "BN (Battalion).png"));
                return layered;
            case "Brigade.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Order of Battle/", "BDE (Brigade).png"));
                return layered;
            case "Close Air Support.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Type/", "CAS (Close Air Support).png"));
                return layered;
            case "Company.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Order of Battle/", "CO (Company).png"));
                return layered;
            case "Division.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Order of Battle/", "DIV (Division).png"));
                return layered;
            case "Field Arty.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Type/", "FA (Field Artillery).png"));
                return layered;
            case "Fire Support Team.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Type/", "FIRE (Fire Support).png"));
                return layered;
            case "Headquarters.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
            ...
            case "Lance.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Order of Battle/", "LANCE.png"));
                return layered;
            ...
            case "Platoon.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Order of Battle/", "PLT (Platoon).png"));
                return layered;
            case "Recon.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
            ...
            case "Regiment.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Order of Battle/", "RGT (Regiment).png"));
                return layered;
            default:
                return icon;
        }
    ...
    private static StandardForceIcon migrateStandardMiscellaneous(final StandardForceIcon icon) {
        ...
        switch (icon.getFilename()) {
            ...
            case "specialforcessquad.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Type/", "SF (Special Forces).png"));
                layered.getPieces().put(LayeredForceIconLayer.FORMATION, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.FORMATION)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.FORMATION, "Inner Sphere/", "(02) Individual.png"));
                return layered;
    ...
    private static StandardForceIcon migrateStandardNames(final StandardForceIcon icon) {
        ...
        switch (icon.getFilename()) {
            ...
            case "Striker.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.TYPE, "Alphanumeric/Lance Names/", "STRIKER.png"));
                return layered;
            case "Sweep.png":
                layered.getPieces().put(LayeredForceIconLayer.TYPE, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.TYPE)
    ...
    private static StandardForceIcon migrateStandardUnits(final StandardForceIcon icon) {
        ...
        switch (icon.getFilename()) {
            ...
            case "RepublicOfTheSphere.png":
                layered.getPieces().put(LayeredForceIconLayer.LOGO, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.LOGO)
                        .add(new ForcePieceIcon(LayeredForceIconLayer.LOGO, "Inner Sphere/", "Republic of the Sphere.png"));
                return layered;
            case "SorensonSabres.jpg":
        ...
        switch (icon.getFilename()) {
            ...
            case "rvtolattackcargoflight.png":
                ...
                layered.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Right/English Letters/", "A.png"));
                layered.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Bottom Right/English Letters/", "C.png"));
                return layered;
            ...
            case "VTOL Attack Element Reinforced C3 EW P.png":
                ...
                layered.getPieces().put(LayeredForceIconLayer.FORMATION, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.FORMATION)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.FORMATION, "Inner Sphere/", "(03A) Augmented Team.png"));
                layered.getPieces().put(LayeredForceIconLayer.ALPHANUMERIC, new ArrayList<>());
                layered.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
                            .add(new ForcePieceIcon(LayeredForceIconLayer.ALPHANUMERIC, "Top Left/", "C3.png"));
                layered.getPieces().get(LayeredForceIconLayer.ALPHANUMERIC)
