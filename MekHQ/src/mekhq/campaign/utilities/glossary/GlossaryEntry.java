...
public enum GlossaryEntry {
    ...
    BLOODNAME("BLOODNAME", new Version("0.51.01")),
    BLOODRIGHT("BLOODRIGHT", new Version("0.51.01")),
    ...
    CHASSIS_FAMILIARITY("CHASSIS_FAMILIARITY", new Version("0.51.01")),
    COMBAT_ROLES("COMBAT_ROLES", new Version("0.50.10")),
    COMBAT_TEAMS("COMBAT_TEAMS", new Version("0.50.10")),
    COMMAND_GENERATOR("COMMAND_GENERATOR", new Version("0.51.01")),
    COMMAND_GENERATOR_AUGMENTATION("COMMAND_GENERATOR_AUGMENTATION", new Version("0.51.01")),
    COMMAND_GENERATOR_FINANCES("COMMAND_GENERATOR_FINANCES", new Version("0.51.01")),
    COMMAND_GENERATOR_FORCE("COMMAND_GENERATOR_FORCE", new Version("0.51.01")),
    COMMAND_GENERATOR_OFFICERS("COMMAND_GENERATOR_OFFICERS", new Version("0.51.01")),
    COMMAND_GENERATOR_SIMULATION("COMMAND_GENERATOR_SIMULATION", new Version("0.51.01")),
    COMMAND_GENERATOR_SUPPORT("COMMAND_GENERATOR_SUPPORT", new Version("0.51.01")),
    COMMAND_RIGHTS("COMMAND_RIGHTS", new Version("0.51.01")),
    ...
    ESCALATION("ESCALATION", new Version("0.51.01")),
    ...
    GENETIC_LEGACY("GENETIC_LEGACY", new Version("0.51.01")),
    ...
    ISORLA("ISORLA", new Version("0.51.01")),
    ...
    MANAGEMENT_SKILL("MANAGEMENT_SKILL", new Version("0.51.00")),
    ...
    MISSION_CONCLUSION_HELP("MISSION_CONCLUSION_HELP", new Version("0.50.06")),
    MISSION_TYPES("MISSION_TYPES", new Version("0.51.0")),
    MISSION_TYPE_ASSASSINATION("MISSION_TYPE_ASSASSINATION", new Version("0.51.01")),
    MISSION_TYPE_CADRE_DUTY("MISSION_TYPE_CADRE_DUTY", new Version("0.51.01")),
    MISSION_TYPE_DIVERSIONARY_RAID("MISSION_TYPE_DIVERSIONARY_RAID", new Version("0.51.01")),
    MISSION_TYPE_ESPIONAGE("MISSION_TYPE_ESPIONAGE", new Version("0.51.01")),
    MISSION_TYPE_EXTRACTION_RAID("MISSION_TYPE_EXTRACTION_RAID", new Version("0.51.01")),
    MISSION_TYPE_GARRISON_DUTY("MISSION_TYPE_GARRISON_DUTY", new Version("0.51.01")),
    MISSION_TYPE_GUERRILLA_WARFARE("MISSION_TYPE_GUERRILLA_WARFARE", new Version("0.51.01")),
    MISSION_TYPE_MOLE_HUNTING("MISSION_TYPE_MOLE_HUNTING", new Version("0.51.01")),
    MISSION_TYPE_OBJECTIVE_RAID("MISSION_TYPE_OBJECTIVE_RAID", new Version("0.51.01")),
    MISSION_TYPE_OBSERVATION_RAID("MISSION_TYPE_OBSERVATION_RAID", new Version("0.51.01")),
    MISSION_TYPE_PIRATE_HUNTING("MISSION_TYPE_PIRATE_HUNTING", new Version("0.51.01")),
    MISSION_TYPE_PIRATE_RAID("MISSION_TYPE_PIRATE_RAID", new Version("0.51.01")),
    MISSION_TYPE_PLANETARY_ASSAULT("MISSION_TYPE_PLANETARY_ASSAULT", new Version("0.51.01")),
    MISSION_TYPE_RECON_RAID("MISSION_TYPE_RECON_RAID", new Version("0.51.01")),
    MISSION_TYPE_RELIEF_DUTY("MISSION_TYPE_RELIEF_DUTY", new Version("0.51.01")),
    MISSION_TYPE_RETAINER("MISSION_TYPE_RETAINER", new Version("0.51.01")),
    MISSION_TYPE_RIOT_DUTY("MISSION_TYPE_RIOT_DUTY", new Version("0.51.01")),
    MISSION_TYPE_SABOTAGE("MISSION_TYPE_SABOTAGE", new Version("0.51.01")),
    MISSION_TYPE_SECURITY_DUTY("MISSION_TYPE_SECURITY_DUTY", new Version("0.51.01")),
    MISSION_TYPE_TERRORISM("MISSION_TYPE_TERRORISM", new Version("0.51.01")),
    ...
    PHENOTYPE("PHENOTYPE", new Version("0.51.01")),
    ...
    SEED_FORCES("SEED_FORCES", new Version("0.51.01")),
    ...
    STRATCON_SCENARIOS("STRATCON_SCENARIOS", new Version("0.50.11")),
    ...
    SUPPORT_TEAMS("SUPPORT_TEAMS", new Version("0.51.01")),
