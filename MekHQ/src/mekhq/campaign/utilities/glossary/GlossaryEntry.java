...
public enum GlossaryEntry {
    ...
    ADVANCED_MEDICAL("ADVANCED_MEDICAL", new Version("0.50.11")),
    ...
    CONTRACT_TYPES("CONTRACT_TYPES", new Version("0.51.0")),
    CONTRACT_TYPE_ASSASSINATION("CONTRACT_TYPE_ASSASSINATION", new Version("0.51.0")),
    CONTRACT_TYPE_CADRE_DUTY("CONTRACT_TYPE_CADRE_DUTY", new Version("0.51.0")),
    CONTRACT_TYPE_DIVERSIONARY_RAID("CONTRACT_TYPE_DIVERSIONARY_RAID", new Version("0.51.0")),
    CONTRACT_TYPE_ESPIONAGE("CONTRACT_TYPE_ESPIONAGE", new Version("0.51.0")),
    CONTRACT_TYPE_EXTRACTION_RAID("CONTRACT_TYPE_EXTRACTION_RAID", new Version("0.51.0")),
    CONTRACT_TYPE_GARRISON_DUTY("CONTRACT_TYPE_GARRISON_DUTY", new Version("0.51.0")),
    CONTRACT_TYPE_GUERRILLA_WARFARE("CONTRACT_TYPE_GUERRILLA_WARFARE", new Version("0.51.0")),
    CONTRACT_TYPE_MOLE_HUNTING("CONTRACT_TYPE_MOLE_HUNTING", new Version("0.51.0")),
    CONTRACT_TYPE_OBJECTIVE_RAID("CONTRACT_TYPE_OBJECTIVE_RAID", new Version("0.51.0")),
    CONTRACT_TYPE_OBSERVATION_RAID("CONTRACT_TYPE_OBSERVATION_RAID", new Version("0.51.0")),
    CONTRACT_TYPE_PIRATE_HUNTING("CONTRACT_TYPE_PIRATE_HUNTING", new Version("0.51.0")),
    CONTRACT_TYPE_PLANETARY_ASSAULT("CONTRACT_TYPE_PLANETARY_ASSAULT", new Version("0.51.0")),
    CONTRACT_TYPE_RECON_RAID("CONTRACT_TYPE_RECON_RAID", new Version("0.51.0")),
    CONTRACT_TYPE_RELIEF_DUTY("CONTRACT_TYPE_RELIEF_DUTY", new Version("0.51.0")),
    CONTRACT_TYPE_RETAINER("CONTRACT_TYPE_RETAINER", new Version("0.51.0")),
    CONTRACT_TYPE_RIOT_DUTY("CONTRACT_TYPE_RIOT_DUTY", new Version("0.51.0")),
    CONTRACT_TYPE_SABOTAGE("CONTRACT_TYPE_SABOTAGE", new Version("0.51.0")),
    CONTRACT_TYPE_SECURITY_DUTY("CONTRACT_TYPE_SECURITY_DUTY", new Version("0.51.0")),
    CONTRACT_TYPE_TERRORISM("CONTRACT_TYPE_TERRORISM", new Version("0.51.0")),
