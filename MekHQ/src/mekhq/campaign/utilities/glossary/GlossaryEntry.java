...
public enum GlossaryEntry {
    ...
    MISSION_TYPE_ASSASSINATION("MISSION_TYPE_ASSASSINATION", new Version("0.51.0")),
    MISSION_TYPE_CADRE_DUTY("MISSION_TYPE_CADRE_DUTY", new Version("0.51.0")),
    MISSION_TYPE_DIVERSIONARY_RAID("MISSION_TYPE_DIVERSIONARY_RAID", new Version("0.51.0")),
    MISSION_TYPE_ESPIONAGE("MISSION_TYPE_ESPIONAGE", new Version("0.51.0")),
    MISSION_TYPE_EXTRACTION_RAID("MISSION_TYPE_EXTRACTION_RAID", new Version("0.51.0")),
    MISSION_TYPE_GARRISON_DUTY("MISSION_TYPE_GARRISON_DUTY", new Version("0.51.0")),
    MISSION_TYPE_GUERRILLA_WARFARE("MISSION_TYPE_GUERRILLA_WARFARE", new Version("0.51.0")),
    MISSION_TYPE_MOLE_HUNTING("MISSION_TYPE_MOLE_HUNTING", new Version("0.51.0")),
    MISSION_TYPE_OBJECTIVE_RAID("MISSION_TYPE_OBJECTIVE_RAID", new Version("0.51.0")),
    MISSION_TYPE_OBSERVATION_RAID("MISSION_TYPE_OBSERVATION_RAID", new Version("0.51.0")),
    MISSION_TYPE_PIRATE_HUNTING("MISSION_TYPE_PIRATE_HUNTING", new Version("0.51.0")),
    MISSION_TYPE_PLANETARY_ASSAULT("MISSION_TYPE_PLANETARY_ASSAULT", new Version("0.51.0")),
    MISSION_TYPE_RECON_RAID("MISSION_TYPE_RECON_RAID", new Version("0.51.0")),
    MISSION_TYPE_RELIEF_DUTY("MISSION_TYPE_RELIEF_DUTY", new Version("0.51.0")),
    MISSION_TYPE_RETAINER("MISSION_TYPE_RETAINER", new Version("0.51.0")),
    MISSION_TYPE_RIOT_DUTY("MISSION_TYPE_RIOT_DUTY", new Version("0.51.0")),
    MISSION_TYPE_SABOTAGE("MISSION_TYPE_SABOTAGE", new Version("0.51.0")),
    MISSION_TYPE_SECURITY_DUTY("MISSION_TYPE_SECURITY_DUTY", new Version("0.51.0")),
    MISSION_TYPE_TERRORISM("MISSION_TYPE_TERRORISM", new Version("0.51.0")),
