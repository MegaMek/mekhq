 ...
 * @author Luana Coppio
 */
public abstract class AbstractAcActionHandler implements AcActionHandler {

    private final EntityAction action;
    private final AcGameManager gameManager;
    private boolean isFinished = false;

    public AbstractAcActionHandler(EntityAction action, AcGameManager gameManager) {
        this.action = action;
    ...
    @Override
    public AcGameManager gameManager() {
        return gameManager;
    }
}
