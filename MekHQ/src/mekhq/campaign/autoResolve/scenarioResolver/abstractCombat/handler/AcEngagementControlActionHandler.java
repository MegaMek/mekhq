...
import mekhq.campaign.autoResolve.scenarioResolver.abstractCombat.reporter.AcEngagementControlReporter;
 ...
 * @author Luana Coppio
 */
public class AcEngagementControlActionHandler extends AbstractAcActionHandler {

    private final AcEngagementControlReporter reporter;

    public AcEngagementControlActionHandler(AcsEngagementControlAction action, AcGameManager gameManager) {
        super(action, gameManager);
        this.reporter = new AcEngagementControlReporter(gameManager.getGame(), this::addReport);
    }
