...
import mekhq.campaign.autoResolve.scenarioResolver.abstractCombat.handler.AcEngagementControlActionHandler;
...
public class AcsEngagementControlAction implements AcsAction, Serializable {
    ...
    public AcActionHandler getHandler(AcGameManager gameManager) {
        return new AcEngagementControlActionHandler(this, gameManager);
    }
