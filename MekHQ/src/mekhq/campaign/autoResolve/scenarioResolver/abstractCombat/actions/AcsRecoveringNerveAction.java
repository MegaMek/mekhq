...
import mekhq.campaign.autoResolve.scenarioResolver.abstractCombat.handler.AcRecoveringNerveActionHandler;
...
public class AcsRecoveringNerveAction implements AcsAction, Serializable {
    ...
    public AcActionHandler getHandler(AcGameManager gameManager) {
        return new AcRecoveringNerveActionHandler(this, gameManager);
    }
