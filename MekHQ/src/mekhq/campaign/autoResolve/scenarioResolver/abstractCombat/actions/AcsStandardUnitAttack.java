...
import mekhq.campaign.autoResolve.scenarioResolver.abstractCombat.handler.AcStandardUnitAttackHandler;
...
public class AcsStandardUnitAttack extends AbstractAcsAttackAction {
     ...
     */
    public AcsStandardUnitAttack(int formationId, int unitNumber, int targetId, ASRange range, ManeuverResult maneuverResult) {
    ...
    public ManeuverResult getManueverResult() {
        return maneuverResult;
    }

    @Override
    public AcActionHandler getHandler(AcGameManager gameManager) {
        return new AcStandardUnitAttackHandler(this, gameManager);
    }
    ...
    public boolean isDataValid(IGame game) {
        ...
        Optional<AcFormation> possibleAttacker = autoResolveGame.getFormation(getEntityId());
        Optional<AcFormation> possibleTarget = autoResolveGame.getFormation(getTargetId());
