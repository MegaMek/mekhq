...
import mekhq.campaign.autoResolve.scenarioResolver.abstractCombat.reporter.AcPublicReportEntry;

/**
 * @author Luana Coppio
 */
public record AcPhaseEndManager(AcGameManager gameManager) implements AcGameManagerHelper {

    void managePhase() {
        switch (gameManager.getGame().getPhase()) {
            case INITIATIVE:
                gameManager.addReport(new AcPublicReportEntry(999));
            ...
            case MOVEMENT:
                gameManager.addReport(new AcPublicReportEntry(999));
                gameManager.addReport(new AcPublicReportEntry(2201));
                gameManager.actionsProcessor.handleActions();
                phaseCleanup();
            ...
            case FIRING:
                gameManager.addReport(new AcPublicReportEntry(999));
                gameManager.addReport(new AcPublicReportEntry(2002));
                gameManager.actionsProcessor.handleActions();
                phaseCleanup();
