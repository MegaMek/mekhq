...
import mekhq.campaign.autoResolve.scenarioResolver.abstractCombat.reporter.StartingScenarioReporter;
...
public class StartingScenarioPhase extends PhaseHandler {
    ...
    public StartingScenarioPhase(AcGameManager gameManager) {
