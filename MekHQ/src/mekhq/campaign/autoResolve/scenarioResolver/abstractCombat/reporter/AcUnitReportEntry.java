...
public class AcUnitReportEntry  extends AcReportEntry {

        private final String formationName;
        private final String unitName;
        private final String playerColorHex;

        public AcUnitReportEntry(String formationName, String unitName, String playerColorHex) {
            super(0);
        ...
        public AcUnitReportEntry(AcFormation formation, int unitIndex, Color color) {
        ...
        private static String unitName(AcFormation formation, int unitIndex) {
