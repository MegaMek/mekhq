...
public class AcFormationReportEntry extends AcReportEntry {

    private final String formationName;
    private final String playerColorHex;

    public AcFormationReportEntry(String formationName, String playerColorHex) {
        super(0);
    ...
    public AcFormationReportEntry(AcFormation formation, IGame game) {
