...
import mekhq.campaign.autoResolve.scenarioResolver.abstractCombatSystem.reporter.AcsRecoveringNerveActionReporter;
...
public class AcsRecoveringNerveActionHandler extends AbstractAcsActionHandler {
    ...
    private final AcsRecoveringNerveActionReporter report;
    ...
    public AcsRecoveringNerveActionHandler(AcsRecoveringNerveAction action, AcsGameManager gameManager) {
        ...
        this.report = new AcsRecoveringNerveActionReporter(game(), this::addReport);
    }
    ...
    public void handle() {
        ...
        if (!recoveringNerveAction.isIllegal()) {
            ...
            AcsFormation formation = formationOpt.get();
