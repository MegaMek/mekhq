...
import mekhq.campaign.autoResolve.scenarioResolver.abstractCombatSystem.reporter.AcsAttackReporter;
...
public class AcsStandardUnitAttackHandler extends AbstractAcsActionHandler {
    ...
    private void resolveAttack(AcsFormation attacker, AcsStandardUnitAttack attack, AcsFormation target, SBFUnit targetUnit) {
    ...
    private int calculateDamage(AcsFormation attacker, AcsStandardUnitAttack attack,
                                SBFUnit attackingUnit, AcsFormation target) {
        int damage = 0;
    ...
    private void handleCrits(AcsFormation target, SBFUnit targetUnit, int criticalRollResult, SBFUnit attackingUnit) {
