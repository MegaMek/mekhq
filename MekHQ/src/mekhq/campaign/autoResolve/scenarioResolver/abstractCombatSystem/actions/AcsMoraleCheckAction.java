...
import mekhq.campaign.autoResolve.scenarioResolver.abstractCombatSystem.handler.AcsMoraleCheckActionHandler;
...
public class AcsMoraleCheckAction implements AcsAction, Serializable {
    ...
    public AcsActionHandler getHandler(AcsGameManager gameManager) {
        return new AcsMoraleCheckActionHandler(this, gameManager);
    }
