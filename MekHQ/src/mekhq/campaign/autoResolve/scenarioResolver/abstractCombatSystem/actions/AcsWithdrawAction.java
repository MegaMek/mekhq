...
import mekhq.campaign.autoResolve.scenarioResolver.abstractCombatSystem.handler.AcsWithdrawActionHandler;
 ...
 * @author Luana Coppio
 */
public class AcsWithdrawAction implements AcsAction, Serializable {

    private final int formationId;

    public AcsWithdrawAction(int formationId) {
    ...
    public AcsActionHandler getHandler(AcsGameManager gameManager) {
        return new AcsWithdrawActionHandler(this, gameManager);
    }
    ...
    public String toString() {
        return "[AcsWithdrawAction]: ID: " + formationId;
    }
}
