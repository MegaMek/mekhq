...
public class AcsRecoveringNerveActionToHitData extends TargetRoll {
    ...
    public static AcsRecoveringNerveActionToHitData compileToHit(AutoResolveGame game, AcsRecoveringNerveAction recoveringNerveAction) {
        ...
        AcsFormation formation = game.getFormation(recoveringNerveAction.getEntityId()).get();
    ...
    private static void processSkill(AcsRecoveringNerveActionToHitData toHit, AutoResolveGame game, AcsFormation formation) {
