...
public class AcsReportEntry implements ReportEntry {
    ...
    public AcsReportEntry(int messageId) {
     ...
     */
    public AcsReportEntry add(int data) {
     ...
     * @return This Report to allow chaining
     */
    public AcsReportEntry add(int data, boolean obscure) {
     ...
     * @return This Report to allow chaining
     */
    public AcsReportEntry add(String data) {
     ...
     * @return This Report to allow chaining
     */
    public AcsReportEntry add(String data, boolean obscure) {
     ...
     * @return This Report to allow chaining
     */
    public AcsReportEntry indent(int n) {
        indentation += (n * Report.DEFAULT_INDENTATION);
        return this;
    }

    public AcsReportEntry subject(int id) {
        return this;
    }

    public AcsReportEntry newLines(int count) {
        return this;
    }

    public AcsReportEntry noNL() {
        endLine = false;
        return this;
    }

    public AcsReportEntry endSpace() {
        endSpace = true;
        return this;
    }

    public AcsReportEntry addNL() {
        endLine = true;
        return this;
    }
    ...
    protected String reportText() {
        return AcsReportMessages.getString(String.valueOf(messageId), data.stream().map(d -> (Object) d.data).toList());
    }
}
