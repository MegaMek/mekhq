...
public class AcsPlayerNameReportEntry extends AcsReportEntry {

    private final String playerName;
    private final String playerColorHex;

    public AcsPlayerNameReportEntry(Player player) {
        this(player.getName(), player.getColour());
        noNL();
    }

    public AcsPlayerNameReportEntry(String playerName, String playerColorHex) {
        super(0);
        this.playerName = playerName;
        this.playerColorHex = playerColorHex;
    }

    public AcsPlayerNameReportEntry(String playerName, PlayerColour color) {
