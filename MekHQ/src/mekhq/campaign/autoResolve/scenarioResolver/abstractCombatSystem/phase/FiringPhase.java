...
public class FiringPhase extends PhaseHandler {
    ...
    public FiringPhase(AcsGameManager gameManager) {
    ...
    private void standardUnitAttacks(AttackRecord attackRecord) {
        ...
        var actingFormationToHit = AcsManeuverToHitData.compileToHit(getGameManager().getGame(), actingFormation);
        var targetFormationToHit = AcsManeuverToHitData.compileToHit(getGameManager().getGame(), target);

        ASRange range = ASRange.LONG;
        AcsStandardUnitAttack.ManueverResult manueverModifier = AcsStandardUnitAttack.ManueverResult.DRAW;
        ...
        var maxAttacks = manueverModifier == AcsStandardUnitAttack.ManueverResult.FAILURE ? maxAttacksOnFailure : maxAttacksNormally;
    ...
    private record AttackRecord(AcsFormation actingFormation, AcsFormation target, List<Integer> attackingUnits) { }

    private List<AttackRecord> attack(AcsFormation actingFormation) {
    ...
    private List<AcsFormation> selectTarget(AcsFormation actingFormation) {
...
//            .filter(f -> f.isGround() == actingFormation.isGround())
    ...
    private boolean formationWasOverrunByFormation(AcsFormation actingFormation, AcsFormation target) {
        return engagementAndControlResult(actingFormation, target, EngagementControl.OVERRUN);
    }

    private boolean formationWasEvadedByFormation(AcsFormation actingFormation, AcsFormation target) {
        return engagementAndControlResult(actingFormation, target, EngagementControl.EVADE);
    }

    private boolean formationWasForcedByFormation(AcsFormation actingFormation, AcsFormation target) {
        return engagementAndControlResult(actingFormation, target, EngagementControl.FORCED_ENGAGEMENT);
    }

    private boolean engagementAndControlResult(AcsFormation actingFormation, AcsFormation target, EngagementControl engagementControl) {
