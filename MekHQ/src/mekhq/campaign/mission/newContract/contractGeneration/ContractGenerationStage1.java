...
public class ContractGenerationStage1 {
    private static final MMLogger LOGGER = MMLogger.create(ContractGenerationStage1.class);

    static void generateEmployerContractTypeEnemyAndLocation(Campaign campaign, double forceReputationFactor,
