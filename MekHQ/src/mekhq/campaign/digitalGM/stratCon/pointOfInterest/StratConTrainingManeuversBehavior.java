 ...
 *
 * <p>When any formation deploys onto their hex, the maneuvers are completed on the spot and their objective is met.
 * No scenario ever breaks out there - not even the
...
public class StratConTrainingManeuversBehavior implements IStratConPointOfInterestBehavior {
     ...
     * leave the map. No scenario is rolled. They award no chassis familiarity: a Patrol formation already earns it for
     * deploying, and it would otherwise earn it twice.
     *
     * @author Illiani
     * @since 0.51.01
     */
