...
public class CampaignOptions {
    ...
    public CampaignOptions() {
        ...
        setRoleBaseSalary(PersonnelRole.DEPENDENT, 00);
        ...
        setRoleBaseSalary(PersonnelRole.CIVILIAN_GUARD, 250);
        ...
        setRoleBaseSalary(PersonnelRole.FENCE, 250);
        ...
        setRoleBaseSalary(PersonnelRole.FORGER, 250);
