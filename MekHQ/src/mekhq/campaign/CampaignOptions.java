...
public class CampaignOptions implements Serializable {
    ...
    public CampaignOptions() {
        ...
        randomMarriageSurnameWeights[MarriageSurnameStyle.NO_CHANGE.getWeightsNumber()] = 100;
        randomMarriageSurnameWeights[MarriageSurnameStyle.YOURS.getWeightsNumber()] = 55;
        randomMarriageSurnameWeights[MarriageSurnameStyle.SPOUSE.getWeightsNumber()] = 55;
        randomMarriageSurnameWeights[MarriageSurnameStyle.SPACE_YOURS.getWeightsNumber()] = 10;
        randomMarriageSurnameWeights[MarriageSurnameStyle.BOTH_SPACE_YOURS.getWeightsNumber()] = 5;
        randomMarriageSurnameWeights[MarriageSurnameStyle.HYP_YOURS.getWeightsNumber()] = 30;
        randomMarriageSurnameWeights[MarriageSurnameStyle.BOTH_HYP_YOURS.getWeightsNumber()] = 20;
        randomMarriageSurnameWeights[MarriageSurnameStyle.SPACE_SPOUSE.getWeightsNumber()] = 10;
        randomMarriageSurnameWeights[MarriageSurnameStyle.BOTH_SPACE_SPOUSE.getWeightsNumber()] = 5;
        randomMarriageSurnameWeights[MarriageSurnameStyle.HYP_SPOUSE.getWeightsNumber()] = 30;
        randomMarriageSurnameWeights[MarriageSurnameStyle.BOTH_HYP_SPOUSE.getWeightsNumber()] = 20;
        randomMarriageSurnameWeights[MarriageSurnameStyle.MALE.getWeightsNumber()] = 500;
        randomMarriageSurnameWeights[MarriageSurnameStyle.FEMALE.getWeightsNumber()] = 160;
