...
public class CampaignOptions {
    ...
    public CampaignOptions() {
        ...
        setRoleBaseSalary(PersonnelRole.ADULT_ENTERTAINER, 250);
        setRoleBaseSalary(PersonnelRole.ANTIQUARIAN, 250);
        setRoleBaseSalary(PersonnelRole.SPORTS_STAR, 250);
        setRoleBaseSalary(PersonnelRole.ASTROGRAPHER, 250);
        setRoleBaseSalary(PersonnelRole.ADULT_ENTERTAINER, 250);
        setRoleBaseSalary(PersonnelRole.AGRI_FARMER, 250);
        setRoleBaseSalary(PersonnelRole.ANTIQUARIAN, 250);
        setRoleBaseSalary(PersonnelRole.ARTIST, 250);
        setRoleBaseSalary(PersonnelRole.ASTROGRAPHER, 250);
        setRoleBaseSalary(PersonnelRole.BARBER, 250);
        setRoleBaseSalary(PersonnelRole.BARTENDER, 250);
        setRoleBaseSalary(PersonnelRole.BRAWLER, 250);
        setRoleBaseSalary(PersonnelRole.BROKER, 250);
        setRoleBaseSalary(PersonnelRole.BURGLAR, 250);
        setRoleBaseSalary(PersonnelRole.CHEF, 250);
        setRoleBaseSalary(PersonnelRole.CIVILIAN_AERO_MECHANIC, 250);
        setRoleBaseSalary(PersonnelRole.CIVILIAN_DOCTOR, 250);
        setRoleBaseSalary(PersonnelRole.CIVILIAN_DROPSHIP_PILOT, 250);
        setRoleBaseSalary(PersonnelRole.POLICE_OFFICER, 250);
        setRoleBaseSalary(PersonnelRole.CIVILIAN_PILOT, 250);
        setRoleBaseSalary(PersonnelRole.CIVILIAN_VTOL_PILOT, 250);
        setRoleBaseSalary(PersonnelRole.CIVIL_CLERK, 250);
        setRoleBaseSalary(PersonnelRole.CLOWN, 250);
        setRoleBaseSalary(PersonnelRole.CON_ARTIST, 250);
        setRoleBaseSalary(PersonnelRole.COURIER, 250);
        setRoleBaseSalary(PersonnelRole.CRIMINAL_MECHANIC, 250);
        setRoleBaseSalary(PersonnelRole.CULTURAL_CENSOR, 250);
        setRoleBaseSalary(PersonnelRole.CULTURAL_LIAISON, 250);
        setRoleBaseSalary(PersonnelRole.CUSTOMS_INSPECTOR, 250);
        setRoleBaseSalary(PersonnelRole.DATA_ANALYST, 250);
        setRoleBaseSalary(PersonnelRole.DATA_SMUGGLER, 250);
        setRoleBaseSalary(PersonnelRole.DRUG_DEALER, 250);
        setRoleBaseSalary(PersonnelRole.ESCAPED_PRISONER, 250);
        setRoleBaseSalary(PersonnelRole.EXOSKELETON_LABORER, 250);
        setRoleBaseSalary(PersonnelRole.FACTORY_FOREMAN, 250);
        setRoleBaseSalary(PersonnelRole.FACTORY_WORKER, 250);
        setRoleBaseSalary(PersonnelRole.COUNTERFEITER, 250);
        setRoleBaseSalary(PersonnelRole.FIREFIGHTER, 250);
        setRoleBaseSalary(PersonnelRole.FIRING_RANGE_SAFETY_OFFICER, 250);
        setRoleBaseSalary(PersonnelRole.FISHER, 250);
        setRoleBaseSalary(PersonnelRole.COUNTERFEITER, 250);
        setRoleBaseSalary(PersonnelRole.GAMBLER, 250);
        setRoleBaseSalary(PersonnelRole.GENETICIST, 250);
        setRoleBaseSalary(PersonnelRole.HACKER, 250);
        setRoleBaseSalary(PersonnelRole.HERALD, 250);
        setRoleBaseSalary(PersonnelRole.HISTORIAN, 250);
        setRoleBaseSalary(PersonnelRole.HOLO_CARTOGRAPHER, 250);
        setRoleBaseSalary(PersonnelRole.HOLO_GAMER, 250);
        setRoleBaseSalary(PersonnelRole.HOLO_JOURNALIST, 250);
        setRoleBaseSalary(PersonnelRole.HOLO_STAR, 250);
        setRoleBaseSalary(PersonnelRole.INDUSTRIAL_MEK_PILOT, 250);
        setRoleBaseSalary(PersonnelRole.INFORMATION_BROKER, 250);
        setRoleBaseSalary(PersonnelRole.JANITOR, 250);
        setRoleBaseSalary(PersonnelRole.JUMPSHIP_CHEF, 250);
        setRoleBaseSalary(PersonnelRole.LAWYER, 250);
        setRoleBaseSalary(PersonnelRole.LIVESTOCK_FARMER, 250);
        setRoleBaseSalary(PersonnelRole.MEDICAL_RESEARCHER, 250);
        setRoleBaseSalary(PersonnelRole.MEDIATOR, 250);
        setRoleBaseSalary(PersonnelRole.MEK_RANGE_INSTRUCTOR, 250);
        setRoleBaseSalary(PersonnelRole.MERCHANT, 250);
        setRoleBaseSalary(PersonnelRole.MILITARY_ACCOUNTANT, 250);
        setRoleBaseSalary(PersonnelRole.MILITARY_ANALYST, 250);
        setRoleBaseSalary(PersonnelRole.MILITARY_CORONER, 250);
        setRoleBaseSalary(PersonnelRole.MILITARY_LIAISON, 250);
        setRoleBaseSalary(PersonnelRole.MILITARY_THEORIST, 250);
        setRoleBaseSalary(PersonnelRole.MINER, 250);
        setRoleBaseSalary(PersonnelRole.MISCELLANEOUS_JOB, 250);
        setRoleBaseSalary(PersonnelRole.MOUNTAIN_CLIMBER, 250);
        setRoleBaseSalary(PersonnelRole.MUNITIONS_FACTORY_WORKER, 250);
        setRoleBaseSalary(PersonnelRole.MUSICIAN, 250);
        setRoleBaseSalary(PersonnelRole.ORBITAL_DEFENSE_GUNNER, 250);
        setRoleBaseSalary(PersonnelRole.ORBITAL_SHUTTLE_PILOT, 250);
        setRoleBaseSalary(PersonnelRole.PAINTER, 250);
        setRoleBaseSalary(PersonnelRole.PARAMEDIC, 250);
        setRoleBaseSalary(PersonnelRole.PATHFINDER, 250);
        setRoleBaseSalary(PersonnelRole.PERFORMER, 250);
        setRoleBaseSalary(PersonnelRole.PERSONAL_VALET, 250);
        setRoleBaseSalary(PersonnelRole.PROPHET, 250);
        setRoleBaseSalary(PersonnelRole.PROPAGANDIST, 250);
        setRoleBaseSalary(PersonnelRole.PSYCHOLOGIST, 250);
        setRoleBaseSalary(PersonnelRole.RECRUITMENT_SCREENING_OFFICER, 250);
        setRoleBaseSalary(PersonnelRole.RELIGIOUS_LEADER, 250);
        setRoleBaseSalary(PersonnelRole.RELIC_HUNTER, 250);
        setRoleBaseSalary(PersonnelRole.REPAIR_BAY_SUPERVISOR, 250);
        setRoleBaseSalary(PersonnelRole.REVOLUTIONIST, 250);
        setRoleBaseSalary(PersonnelRole.RITUALIST, 250);
        setRoleBaseSalary(PersonnelRole.SALVAGE_RAT, 250);
        setRoleBaseSalary(PersonnelRole.SCRIBE, 250);
        setRoleBaseSalary(PersonnelRole.SCULPTURER, 250);
        setRoleBaseSalary(PersonnelRole.SENSOR_TECHNICIAN, 250);
        setRoleBaseSalary(PersonnelRole.SPACEPORT_WORKER, 250);
        setRoleBaseSalary(PersonnelRole.SPORTS_STAR, 250);
        setRoleBaseSalary(PersonnelRole.SPY, 250);
        setRoleBaseSalary(PersonnelRole.STREET_SURGEON, 250);
        setRoleBaseSalary(PersonnelRole.SWIMMING_INSTRUCTOR, 250);
        setRoleBaseSalary(PersonnelRole.TACTICAL_ANALYST, 250);
        setRoleBaseSalary(PersonnelRole.TAILOR, 250);
        setRoleBaseSalary(PersonnelRole.TEACHER, 250);
        setRoleBaseSalary(PersonnelRole.TECH_COMMUNICATIONS, 250);
        setRoleBaseSalary(PersonnelRole.TECH_FUSION_PLANT, 250);
        setRoleBaseSalary(PersonnelRole.TECH_HYDROPONICS, 250);
        setRoleBaseSalary(PersonnelRole.TECH_SECURITY, 250);
        setRoleBaseSalary(PersonnelRole.TECH_WASTE_MANAGEMENT, 250);
        setRoleBaseSalary(PersonnelRole.TECH_WATER_RECLAMATION, 250);
        setRoleBaseSalary(PersonnelRole.TECH_ZERO_G, 250);
        setRoleBaseSalary(PersonnelRole.THIEF, 250);
        setRoleBaseSalary(PersonnelRole.TRAINING_SIM_OPERATOR, 250);
        setRoleBaseSalary(PersonnelRole.TRANSPORT_DRIVER, 250);
        setRoleBaseSalary(PersonnelRole.WAREHOUSE_WORKER, 250);
        setRoleBaseSalary(PersonnelRole.WAR_CORRESPONDENT, 250);
        setRoleBaseSalary(PersonnelRole.WARFARE_PLANNER, 250);
        setRoleBaseSalary(PersonnelRole.WEATHERCASTER, 250);
        setRoleBaseSalary(PersonnelRole.XENOANIMAL_TRAINER, 250);
        setRoleBaseSalary(PersonnelRole.XENO_BIOLOGIST, 250);
        setRoleBaseSalary(PersonnelRole.MASSEUSE, 250);
        setRoleBaseSalary(PersonnelRole.BODYGUARD, 250);
        setRoleBaseSalary(PersonnelRole.ARTISAN_MICROBREWER, 250);
        setRoleBaseSalary(PersonnelRole.INTERSTELLAR_TOURISM_GUIDE, 250);
        setRoleBaseSalary(PersonnelRole.CORPORATE_CONCIERGE, 250);
        setRoleBaseSalary(PersonnelRole.VIRTUAL_REALITY_THERAPIST, 250);
        setRoleBaseSalary(PersonnelRole.EXOTIC_PET_CARETAKER, 250);
        setRoleBaseSalary(PersonnelRole.CULTURAL_SENSITIVITY_ADVISOR, 250);
        setRoleBaseSalary(PersonnelRole.PLANETARY_IMMIGRATION_ASSESSOR, 250);
        setRoleBaseSalary(PersonnelRole.PERSONAL_ASSISTANT, 250);
        setRoleBaseSalary(PersonnelRole.PENNILESS_NOBLE, 250);
        setRoleBaseSalary(PersonnelRole.AIDE_DE_CAMP, 250);
        setRoleBaseSalary(PersonnelRole.NEUROHELMET_INTERFACE_CALIBRATOR, 250);
        setRoleBaseSalary(PersonnelRole.CIVILIAN_AEROSPACE_INSTRUCTOR, 250);
        setRoleBaseSalary(PersonnelRole.CIVILIAN_JUMPSHIP_NAVIGATOR, 250);
        setRoleBaseSalary(PersonnelRole.POLITICAL_AGITATOR, 250);
        setRoleBaseSalary(PersonnelRole.NOBLE_STEWARD, 250);
        setRoleBaseSalary(PersonnelRole.BATTLE_ROM_EDITOR, 250);
        setRoleBaseSalary(PersonnelRole.LUXURY_COMPANION, 250);
        setRoleBaseSalary(PersonnelRole.PLANETARY_SURVEYOR, 250);
        setRoleBaseSalary(PersonnelRole.DISGRACED_NOBLE, 250);
        setRoleBaseSalary(PersonnelRole.SPACEPORT_BUREAUCRAT, 250);
        setRoleBaseSalary(PersonnelRole.VR_ENTERTAINER, 250);
        setRoleBaseSalary(PersonnelRole.PERSONAL_ARCHIVIST, 250);
        setRoleBaseSalary(PersonnelRole.INDUSTRIAL_INSPECTOR, 250);
        setRoleBaseSalary(PersonnelRole.SPACEPORT_COURIER, 250);
        setRoleBaseSalary(PersonnelRole.MEKBAY_SCHEDULER, 250);
        setRoleBaseSalary(PersonnelRole.MILITARY_CONTRACTOR, 250);
        setRoleBaseSalary(PersonnelRole.MILITARY_HOLO_FILMER, 250);
        setRoleBaseSalary(PersonnelRole.WEAPONS_TESTER, 250);
        setRoleBaseSalary(PersonnelRole.PARAMILITARY_TRAINER, 250);
        setRoleBaseSalary(PersonnelRole.MILITIA_LEADER, 250);
        setRoleBaseSalary(PersonnelRole.FIELD_HOSPITAL_ADMINISTRATOR, 250);
        setRoleBaseSalary(PersonnelRole.CIVILIAN_REQUISITION_OFFICER, 250);
        setRoleBaseSalary(PersonnelRole.TRAINING_SIM_DESIGNER, 250);
        setRoleBaseSalary(PersonnelRole.COMMS_OPERATOR, 250);
        setRoleBaseSalary(PersonnelRole.DECOMMISSIONING_SPECIALIST, 250);
        setRoleBaseSalary(PersonnelRole.WAR_CRIME_INVESTIGATOR, 250);
        setRoleBaseSalary(PersonnelRole.SECURITY_ADVISOR, 250);
        setRoleBaseSalary(PersonnelRole.MILITARY_RECRUITER, 250);
        setRoleBaseSalary(PersonnelRole.MILITARY_PONY_EXPRESS_COURIER, 250);
        setRoleBaseSalary(PersonnelRole.MILITARY_PAINTER, 250);
        setRoleBaseSalary(PersonnelRole.MORALE_OFFICER, 250);
        setRoleBaseSalary(PersonnelRole.COMBAT_CHAPLAIN, 250);
        setRoleBaseSalary(PersonnelRole.LOGISTICS_COORDINATOR, 250);
        setRoleBaseSalary(PersonnelRole.FOOD_TRUCK_OPERATOR, 250);
        setRoleBaseSalary(PersonnelRole.MESS_HALL_MANAGER, 250);
        setRoleBaseSalary(PersonnelRole.CIVILIAN_LIAISON, 250);
        setRoleBaseSalary(PersonnelRole.FIELD_LAUNDRY_OPERATOR, 250);
        setRoleBaseSalary(PersonnelRole.MUNITIONS_CLERK, 250);
        setRoleBaseSalary(PersonnelRole.ARMS_DEALER, 250);
        setRoleBaseSalary(PersonnelRole.SECURITY_DESK_OPERATOR, 250);
        setRoleBaseSalary(PersonnelRole.DATA_LAUNDERER, 250);
        setRoleBaseSalary(PersonnelRole.UNLICENSED_CHEMIST, 250);
        setRoleBaseSalary(PersonnelRole.SMUGGLER, 250);
        setRoleBaseSalary(PersonnelRole.PROTECTION_RACKETEER, 250);
        setRoleBaseSalary(PersonnelRole.THUG, 250);
        setRoleBaseSalary(PersonnelRole.GANG_LEADER, 250);
        setRoleBaseSalary(PersonnelRole.PRISON_FIXER, 250);
        setRoleBaseSalary(PersonnelRole.TORTURER, 250);
        setRoleBaseSalary(PersonnelRole.INTELLIGENCE_ANALYST, 250);
        setRoleBaseSalary(PersonnelRole.CODEBREAKER, 250);
        setRoleBaseSalary(PersonnelRole.COUNTERINTELLIGENCE_LIAISON, 250);
        setRoleBaseSalary(PersonnelRole.DATA_INTERCEPT_OPERATOR, 250);
        setRoleBaseSalary(PersonnelRole.SURVEILLANCE_EXPERT, 250);
        setRoleBaseSalary(PersonnelRole.TECH_ENCRYPTION, 250);
        setRoleBaseSalary(PersonnelRole.DEEP_COVER_OPERATIVE, 250);
        setRoleBaseSalary(PersonnelRole.INTERROGATOR, 250);
        setRoleBaseSalary(PersonnelRole.DATA_HARVESTER, 250);
        setRoleBaseSalary(PersonnelRole.SIGNAL_JAMMING_SPECIALIST, 250);
        setRoleBaseSalary(PersonnelRole.CORPORATE_ESPIONAGE_AGENT, 250);
        setRoleBaseSalary(PersonnelRole.LOYALTY_MONITOR, 250);
        setRoleBaseSalary(PersonnelRole.MEDIA_MANIPULATOR, 250);
        setRoleBaseSalary(PersonnelRole.CIVILIAN_DEBRIEFER, 250);
        setRoleBaseSalary(PersonnelRole.SPACEPORT_ENGINEER, 250);
        setRoleBaseSalary(PersonnelRole.FRONTIER_DOCTOR, 250);
        setRoleBaseSalary(PersonnelRole.DOOMSDAY_PREACHER, 250);
        setRoleBaseSalary(PersonnelRole.TAX_AUDITOR, 250);
        setRoleBaseSalary(PersonnelRole.MARKET_MANIPULATOR, 250);
        setRoleBaseSalary(PersonnelRole.SUBVERSIVE_POET, 250);
        setRoleBaseSalary(PersonnelRole.LEGAL_ARCHIVIST, 250);
        setRoleBaseSalary(PersonnelRole.CONFLICT_RESOLUTION_TRAINER, 250);
        setRoleBaseSalary(PersonnelRole.DUELIST, 250);
        setRoleBaseSalary(PersonnelRole.SCANDAL_FIXER, 250);
        setRoleBaseSalary(PersonnelRole.RELATIONSHIP_MATCHMAKER, 250);
        setRoleBaseSalary(PersonnelRole.PRISON_GUARD, 250);
        ...
        for (int x = 0; x < wList.getLength(); x++) {
            ...
            try {
                ...
                if (nodeName.equalsIgnoreCase("checkMaintenance")) {
                    ...
                    final RandomOriginOptions randomOriginOptions = RandomOriginOptions.parseFromXML(wn2.getChildNodes(),
                          true);
