...
public class DoublePartGenerator extends AbstractPartGenerator {
    //region Constructors
    public DoublePartGenerator() {
        super(PartGenerationMethod.DOUBLE);
    }
    ...
    public List<Part> generate(final List<Part> inputParts) {
        ...
        inputParts.forEach(inputPart -> {
            ...
            part.setQuantity(part.getQuantity() * 2);
            parts.add(part);
        });
        return parts;
    }
