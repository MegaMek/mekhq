...
public class FBattleMechQualityGenerator extends AbstractBattleMechQualityGenerator {
    //region Constructors
    public FBattleMechQualityGenerator() {
        super(BattleMechQualityGenerationMethod.F);
    }
