 ...
 */
public class WindchildBattleMechWeightClassGenerator extends AbstractBattleMechWeightClassGenerator {
    //region Constructors
    public WindchildBattleMechWeightClassGenerator() {
        super(BattleMechWeightClassGenerationMethod.WINDCHILD);
    }
