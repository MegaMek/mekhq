 ...
 */
public class WindchildHeavyBattleMechWeightClassGenerator extends AbstractBattleMechWeightClassGenerator {
    //region Constructors
    public WindchildHeavyBattleMechWeightClassGenerator() {
        super(BattleMechWeightClassGenerationMethod.WINDCHILD_HEAVY);
    }
