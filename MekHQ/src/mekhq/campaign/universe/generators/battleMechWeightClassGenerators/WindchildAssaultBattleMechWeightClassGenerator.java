...
public class WindchildAssaultBattleMechWeightClassGenerator extends AbstractBattleMechWeightClassGenerator {
    //region Constructors
    public WindchildAssaultBattleMechWeightClassGenerator() {
        super(BattleMechWeightClassGenerationMethod.WINDCHILD_ASSAULT);
    }
