...
public enum SupportTOEFormationTypes {
    HQ_FORMATION("HQ_FORMATION", FormationType.STANDARD),
    COMMISSARY_FORMATION("COMMISSARY_FORMATION", FormationType.SUPPORT),
    ...
    SupportTOEFormationTypes(final String lookupName, FormationType type) {
