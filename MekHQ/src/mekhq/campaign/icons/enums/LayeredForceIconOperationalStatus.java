...
public enum LayeredForceIconOperationalStatus {
    ...
    FULLY_OPERATIONAL(MekHqConstants.LAYERED_FORCE_ICON_OPERATIONAL_STATUS_FULLY_OPERATIONAL_FILENAME),
    SUBSTANTIALLY_OPERATIONAL(MekHqConstants.LAYERED_FORCE_ICON_OPERATIONAL_STATUS_SUBSTANTIALLY_OPERATIONAL_FILENAME),
    MARGINALLY_OPERATIONAL(MekHqConstants.LAYERED_FORCE_ICON_OPERATIONAL_STATUS_MARGINALLY_OPERATIONAL_FILENAME),
    NOT_OPERATIONAL(MekHqConstants.LAYERED_FORCE_ICON_OPERATIONAL_STATUS_NOT_OPERATIONAL_FILENAME),
    FACTORY_FRESH(MekHqConstants.LAYERED_FORCE_ICON_OPERATIONAL_STATUS_FACTORY_FRESH_FILENAME);
