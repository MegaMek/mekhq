...
public enum RandomRetirementMethod {
    ...
    AGAINST_THE_BOT_YEARLY("RandomRetirementMethod.AGAINST_THE_BOT_YEARLY.text", "RandomRetirementMethod.AGAINST_THE_BOT_YEARLY.toolTipText"),
    AGAINST_THE_BOT_CONTRACT_END("RandomRetirementMethod.AGAINST_THE_BOT_CONTRACT_END.text", "RandomRetirementMethod.AGAINST_THE_BOT_CONTRACT_END.toolTipText");
    ...
    public boolean isAtBYearly() {
        return this == AGAINST_THE_BOT_YEARLY;
    }

    public boolean isAtBContractEnd() {
        return this == AGAINST_THE_BOT_CONTRACT_END;
    }
...
/*
    public AbstractRetirement getMethod(final CampaignOptions options) {
        switch (this) {
            ...
            case AGAINST_THE_BOT_YEARLY:
                return new AtBYearlyRandomRetirement(options);
            case AGAINST_THE_BOT_CONTRACT_END:
                return new AtBContractEndRandomRetirement(options);
            case NONE:
            default:
