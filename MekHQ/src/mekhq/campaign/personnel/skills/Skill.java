...
public class Skill {
    ...
    /**
     * Calculates the total attribute modifier for the specified character attributes and skill type. This method uses a
     * default {@link TargetRoll} as the context for the calculation.
     *
     * @param characterAttributes the {@link Attributes} object representing the character's attributes
     * @param skillType           the {@link SkillType} for which the modifier is being calculated
     *
     * @return the total attribute modifier as an integer
     */

    public int getTotalAttributeModifier(final Attributes characterAttributes, final SkillType skillType) {
        return getTotalAttributeModifier(new TargetRoll(), characterAttributes, skillType);
    }
