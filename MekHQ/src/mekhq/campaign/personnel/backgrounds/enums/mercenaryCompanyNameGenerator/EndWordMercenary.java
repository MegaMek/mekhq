...
public enum EndWordMercenary {
    ...
    CARABINIERS("EndWordMercenary.CARABINIERS.text"),
    COSSACKS("EndWordMercenary.COSSACKS.text"),
    ...
    CHEVAU_LEGER("EndWordMercenary.CHEVAU_LEGER.text"),
    CHASSUERS("EndWordMercenary.CHASSUERS.text"),
    COMMANDOS("EndWordMercenary.COMMANDOS.text"),
    CONQUERORS("EndWordMercenary.CONQUERORS.text"),
    CUIRASSIERS("EndWordMercenary.CUIRASSIERS.text"),
    ...
    FUSILIERS("EndWordMercenary.FUSILIERS.text"),
    ...
    GRENADIERS("EndWordMercenary.GRENADIERS.text"),
    ...
    REITERS("EndWordMercenary.REITERS.text"),
    RESOLUTES("EndWordMercenary.RESOLUTES.text"),
    RIDERS("EndWordMercenary.RIDERS.text"),
    RIFLEMEN("EndWordMercenary.RIFLEMEN.text"),
    ...
    SIPAHIS("EndWordMercenary.SIPAHIS.text"),
    ...
    UHLANS("EndWordMercenary.UHLANS.text"),
    ...
    VOLTIGEURS("EndWordMercenary.VOLTIGEURS.text"),
