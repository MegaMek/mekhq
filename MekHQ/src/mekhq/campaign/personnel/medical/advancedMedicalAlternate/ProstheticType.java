...
public enum ProstheticType {
    ...
    LIVER_FILTRATION_IMPLANT("LIVER_FILTRATION_IMPLANT",
          ...
          false,
          List.of(),
          List.of(ATOW_POISON_RESISTANCE, COMPULSION_ADDICTION)),
    ...
    CYBERNETIC_EYE_EM_IR("CYBERNETIC_EYE_EM_IR",
          ...
          false,
          List.of(),
          List.of(MISC_EAGLE_EYES, COMPULSION_ADDICTION)),
    ...
    COSMETIC_BEAUTY_ENHANCEMENT("COSMETIC_BEAUTY_ENHANCEMENT",
          ...
          false,
          List.of(),
          List.of(ATOW_ATTRACTIVE, COMPULSION_ADDICTION)),
    COSMETIC_HORROR_ENHANCEMENT("COSMETIC_HORROR_ENHANCEMENT",
          ...
          false,
          List.of(),
          List.of(FLAW_UNATTRACTIVE, COMPULSION_ADDICTION)),
