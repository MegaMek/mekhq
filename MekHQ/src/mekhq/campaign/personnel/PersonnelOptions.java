...
public class PersonnelOptions extends PilotOptions {
    ...
    public static final String SPOTLESS_RECORD = "spotless_record";
    public static final String RAP_SHEET = "rap_sheet";
    public static final String ABOVE_THEIR_WEIGHT = "above_their_weight";
    ...
    public void initialize() {
        ...
        addOption(l3a, SPOTLESS_RECORD, false);
        addOption(l3a, RAP_SHEET, false);
        addOption(l3a, ABOVE_THEIR_WEIGHT, false);
