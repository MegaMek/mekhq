...
public class Academy implements Comparable<Academy> {
    ...
    public static String skillParser(String skill) {
        ...
        String result = switch (normalized) {
            ...
            case "tech/mek", "technician/mek" -> SkillType.S_TECH_MEK;
            case "tech/mechanic", "technician/vehicle" -> SkillType.S_TECH_VEHICLE;
            case "tech/aero", "technician/aerospace" -> SkillType.S_TECH_AERO;
            case "tech/battlearmor", "technician/battlearmor" -> SkillType.S_TECH_BA;
            case "tech/vessel", "technician/vessel" -> SkillType.S_TECH_VESSEL;
            case "technician/military" -> SkillType.S_TECH_MILITARY;
            case "technician/civilian" -> SkillType.S_TECH_CIVILIAN;
            case "technician/electronic" -> SkillType.S_TECH_ELECTRONIC;
            case "technician/nuclear" -> SkillType.S_TECH_NUCLEAR;
            case "technician/aeronautics" -> SkillType.S_TECH_AERONAUTICS;
            case "technician/mechanical" -> SkillType.S_TECH_MECHANICAL;
            case "technician/myomer" -> SkillType.S_TECH_MYOMER;
            case "technician/jets" -> SkillType.S_TECH_JETS;
            case "technician/weapons" -> SkillType.S_TECH_WEAPONS;
            case "technician/cybernetics" -> SkillType.S_TECH_CYBERNETICS;
