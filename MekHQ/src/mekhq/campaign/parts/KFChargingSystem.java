...
public class KFChargingSystem extends Part {
    ...
    public KFChargingSystem(int tonnage, int coreType, Campaign c) {
        super(tonnage, c);
    ...
    public KFChargingSystem clone() {
    	KFChargingSystem clone = new KFChargingSystem(0, coreType, campaign);
	...
	public MissingPart getMissingPart() {
		return new MissingKFChargingSystem(getUnitTonnage(), coreType, campaign);
	}
