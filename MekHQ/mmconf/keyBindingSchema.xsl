...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema" elementFormDefault="qualified">
  ...
  <xs:element name="KeyBind">
    ...
    <!-- Boolean flag that determines whether this command should be repeated when the key is held
    down -->
    ...
    <!-- The string command that will be executed when this key is pressed, for a list of commands
    see megamek.client.ui.swing.util.KeyBindCommand -->
